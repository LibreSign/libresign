...
final class SignatureStampPreviewController extends AEnvironmentAwareController {
	public function __construct(
		IRequest $request,
		private SignatureStampPreviewNativeService $signatureStampPreviewNativeService,
	 ...
	 *
	 * @return DataDownloadResponse<Http::STATUS_OK, 'application/pdf', array{}>|DataResponse<Http::STATUS_FORBIDDEN|Http::STATUS_UNPROCESSABLE_ENTITY, LibresignErrorResponse, array{}>
	 *
	 * 200: Preview PDF
	 * 403: Forbidden
	 * 422: Rendering error
	...
	public function previewPdf(
		...
		try {
			$pdf = $this->signatureStampPreviewNativeService->renderPreviewPdf(
				template: $template,
