	...
	public function get(string|\BackedEnum $policyKey): IPolicyDefinition {
		return match (PolicyKeyNormalizer::normalize($policyKey)) {
			self::KEY => new PolicySpec(
				...
				// whether their signers may reject. It is never read from the signer:
				// the effective value always comes from the snapshot frozen on the
				// document in the context of whoever requested the signature.
				supportedScopes: [
