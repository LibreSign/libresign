...
export type SystemCompoundPolicyWritePayload = ApiRequestJsonBody<AdminOperations['policy-set-system-compound']>
export type SystemCompoundPolicyWriteResponse = ApiOcsResponseData<AdminOperations['policy-set-system-compound'], 200>
export type GroupCompoundPolicyWritePayload = ApiRequestJsonBody<ApiOperations['policy-set-group-compound']>
export type GroupCompoundPolicyWriteResponse = ApiOcsResponseData<ApiOperations['policy-set-group-compound'], 200>
export type UserPreferenceCompoundPolicyWritePayload = ApiRequestJsonBody<ApiOperations['policy-set-user-preference-compound']>
