...
final class SignerDisplayStatusTest extends TestCase {
	...
	public static function mapping(): array {
		return [
			...
			[SignRequestStatus::OBSERVING, SignerDisplayStatus::OBSERVING],
		];
	}
	...
	public static function labels(): array {
		return [
			...
			[SignerDisplayStatus::OBSERVING, 'Observing'],
	...
	public function testTheApiValuesAreTheOnesOfTheContract(): void {
		$this->assertSame(
			['draft', 'ready_to_sign', 'signed', 'rejected', 'observing', 'not_signed'],
