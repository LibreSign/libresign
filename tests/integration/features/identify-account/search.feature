Feature: search
  ...
  Scenario: Search account by specific user
    ...
    And the response should be a JSON array with the following mandatory values
      | key      | value             |
      | ocs | {"meta":{"status":"ok","statuscode":200,"message":"OK"},"data":[{"id":"search-signer1","isNoUser":false,"displayName":"search-signer1-displayname","subname":"search-signer1"}]} |
  ...
  Scenario: Search account by multiple users
    ...
    And the response should be a JSON array with the following mandatory values
      | key      | value             |
      | ocs | {"meta":{"status":"ok","statuscode":200,"message":"OK"},"data":[{"id":"search-signer1","isNoUser":false,"displayName":"search-signer1-displayname","subname":"search-signer1"},{"id":"search-signer2","isNoUser":false,"displayName":"search-signer2-displayname","subname":"search-signer2"}]} |
