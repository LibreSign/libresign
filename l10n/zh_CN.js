OC.L10N.register(
    ...
    "No signers." : "无签署人",
    "You must not sign this file." : "你不可以在这个文件上签名。",
    ...
    "File type: %s. Invalid base64 file." : "文件类型：%s。无效的 base64 文件",
    ...
    "Coordinate %s must be equal to or greater than 0" : "坐标 %s 必须等于或大于 0",
    ...
    "Do not use code when signing method is with password." : "当签名方式是密码时不使用代码",
    "Invalid code." : "无效的代码",
    ...
    "Authorize signing using %s token is disabled because Nextcloud Two-Factor Gateway is not enabled." : "使用 %s 令牌授权签名已被禁用，因未启用 Nextcloud 双因素认证门户",
    ...
    "Insert Signature and/or Initials" : "插入签名和/或首字母",
    "Return" : "返回",
    "Email" : "邮箱",
    "Description" : "描述",
    "Add" : "添加",
    ...
    "You need to create a password to sign this document. Click \"Create password to sign document\" and create a password." : "您需要创建一个密码来签署这个文件，点击“创建密码来签署文件”并创建一个密码 ",
    ...
    "Yes" : "是",
    "No" : "否",
    "Congratulations, you have created your account. Please wait, we will redirect you to the requested signature file." : "恭喜，您已创建账户。请稍候，我们会将您转到所请求的签名文件。",
    ...
    "Status" : "状态",
    "Validate Document" : "验证文档",
    "Pending" : "挂起",
    "Signed" : "已签名 ",
    "Do you want to configure visible elements in this document?" : "是否要配置此文档中的可见元素？",
    ...
    "Select each signer to define theirs signature positions" : "选择每个签名者来定义签名位置",
    "Remove" : "删除",
    "Previous" : "上一个",
    "Create your signature" : "创建你的签名",
    "Create your password for signing PDF" : "创建用于签署 PDF 的密码",
    ...
    "This feature already exists." : "此功能已存在",
    "Feature {feature} enabled." : "功能 {feature} 已启用",
    "This feature does not exist." : "此特性不存在",
    "This feature is already enabled." : "此功能已启用",
    "Feature enabled." : "已启用特性",
    "This feature is not enabled." : "此功能未启用",
    "Feature disabled." : "特性被禁用",
    "User created!" : "用户已创建！",
