OC.L10N.register(
    ...
    "The signature request has been cancelled." : "签名请求已被取消",
    ...
    "Empty file" : "空文件",
    "Inform URL or base64 to sign" : "通知进行签字的 URL 或 base64 ",
    ...
    "Remove duplicated users, email need to be unique" : "删除重复的用户，电子邮件需要是唯一的",
    "Document already signed" : "文档已被签署",
    "No signature was requested to %s" : "没有发给 %s 的签名请求",
    "User need to be email: user %s" : "用户需要是电子邮件：用户 %s",
    ...
    "User created!" : "用户已创建！",
    "Sorry but the page you are looking for does not exist, have been removed, name changed or is temporarily unavailable." : "对不起，你正在寻找的页面不存在，已被删除，名称更改或暂时不可用。",
    ...
    "Signed document available on {place}" : "可在 {place} 找到已签署的文件",
