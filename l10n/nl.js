OC.L10N.register(
    ...
    "Authorize signing using %s token is disabled because Nextcloud Two-Factor Gateway is not enabled." : "Autoriseer ondertekenen met %s token is uitgeschakeld omdat Nextcloud Twee-Factor Gateway niet ingeschakeld is.",
