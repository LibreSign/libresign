OC.L10N.register(
    ...
    "The signature request has been cancelled." : "De handtekeningaanvraag is geannuleerd.",
    ...
    "Inform URL or base64 to sign" : "Informeer URL of base64 voor ondertekenen",
    ...
    "Remove duplicated users, email need to be unique" : "Verwijder dubbele gebruikers, e-mailadres moet uniek zijn",
    "Document already signed" : "Het document is al ondertekend",
    "No signature was requested to %s" : "Geen handtekening gevraagd %s",
    "User need to be email: user %s" : "E-mailadres ontbreekt voor gebruiker %s",
    ...
    "Sorry but the page you are looking for does not exist, have been removed, name changed or is temporarily unavailable." : "Sorry maar de pagina die je zoekt bestaat niet, is verwijderd, de naam is gewijzigd of is tijdelijk niet beschikbaar.",
    ...
    "Signed document available on {place}" : "Ondertekend document beschikbaar op {place}",
