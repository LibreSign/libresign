OC.L10N.register(
    ...
    "You need to complete all required identification factors before signing." : "İmzalamadan önce gerekli tüm kimlik doğrulama adımlarını tamamlamanız gerekir.",
    "_You need to complete at least %n identification factor before signing._::_You need to complete at least %n identification factors before signing._" : ["İmzalamadan önce en az %n kimlik doğrulama adımını tamamlamanız gerekir.","İmzalamadan önce en az %n kimlik doğrulama adımını tamamlamanız gerekir."],
    "Signal" : "Signal",
    ...
    "Identification method: {method}" : "Kimlik doğrulama yöntemi: {method}",
