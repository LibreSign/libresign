OC.L10N.register(
    ...
    "Do not use mixed identify data." : "Karışık kimlik verileri kullanılmasın.",
    ...
    "Invalid data to generate certificate" : "Sertifika üretme verileri geçersiz",
    ...
    "Authorize signing using %s token is disabled because Nextcloud Two-Factor Gateway is not enabled." : "Nextcloud iki adımlı hizmet sağlayıcısı etkinleştirilmemiş olduğundan %s kodu ile kimlik doğrulayarak imzalama devre dışı.",
    ...
    "**This is a libre digital PDF signature app for Nextcloud**\n\n* ✍️ Sign PDF documents using digital signature" : "**Nextcloud için özgür bir sayısal PDF imzalama uygulaması**\n\n* ✍️ Sayısal imza kullanarak PDF belgelerini imzalayın",
    ...
    "Signatures" : "İmzalar",
    "Search signer by account" : "İmzalayıcıyı hesaba göre ara",
    "Name" : "Ad",
    "No recommendations. Start typing." : "Herhangi bir öneri yok. Yazmaya başlayın.",
    "Account is mandatory" : "Hesap zorunludur",
    "Searching …" : "Aranıyor…",
    "No elements found." : "Herhangi bir bileşen bulunamadı.",
    "E-mail of signer" : "İmzalayanın e-posta adresi",
    "Please enter an email address." : "Lütfen bir e-posta adresi yazın",
    "Update" : "Güncelle",
    ...
    "Binaries required to work. Download size could be nearly 340MB, please wait a moment." : "Çalışması için binary dosyaları gerekiyor. Yaklaşık olarak 340MB indirilecek, lütfen bekleyin.",
    ...
    "Allow account creation for new users" : "Yeni kullanıcı hesapları oluşturulabilsin",
    "Allows sending registration email when the user does not have an account." : "Kullanıcının hesabı yoksa bir kayıt e-postası gönderilmesini sağlar.",
    "Default signature method" : "Varsayılan imzalama yöntemi",
    "Identify factors" : "Tanıma etkenleri",
    ...
    "To generate new signatures, you must first generate the root certificate." : "Yeni imzalar üretmek için, öncelikle bir kök sertifika üretmelisiniz.",
    ...
    "Write QR code on footer with validation URL" : "Alt bilgiye doğrulama adresi ile QR kodu ekleyin",
    ...
    "This iframe is not supported in your browser." : "Tarayıcınız bu iFrame ögesini desteklemiyor.",
    "Loading …" : "Yükleniyor…",
    ...
    "File type: %s. Specify a URL, a base64 string or a fileID." : "Dosya türü: %s. Bir adres, bir base64 kodu ya da bir dosya kodu belirtin.",
