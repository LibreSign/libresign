OC.L10N.register(
    ...
    "Date and time when the signer send the request to sign (in their local time zone)." : "簽署人傳送簽署請求的日期與時間（以其當地時區為準）。",
    "Time zone of signer when send the request to sign (in their local time zone)." : "簽署人傳送簽署請求的時區（以其當地時區為準）。",
    ...
    "Certificate valid from:" : "憑證有效期自：",
    "Certificate valid to:" : "憑證有效期至：",
