OC.L10N.register(
    ...
    "The current authenticated session cannot be used to sign this document." : "目前已驗證的工作階段無法用於簽署此文件。",
    "To continue, sign out from the current account and open the signing link again, or open the signing link in a browser session where this account is not active." : "若要繼續，請先登出目前的帳號，然後再次開啟簽署連結；或者在未登入此帳號的瀏覽器工作階段中開啟簽署連結。",
    ...
    "Cannot reach the certificate revocation service. Signing is not allowed." : "無法連線至憑證撤銷服務。無法簽署。",
    "An error occurred during certificate validation. Signing is not allowed." : "無法驗證憑證。無法簽署。",
    "Certificate validation failed. Signing is not allowed. Contact your administrator." : "驗證憑證失敗。無法簽署。請聯絡管理員。",
    "This certificate has no revocation URLs. Signing is not allowed. Contact your administrator." : "此憑證沒有撤銷 URL。無法簽署。請聯絡管理員。",
    "This certificate has no revocation information. Signing is not allowed. Contact your administrator." : "此憑證沒有撤銷資訊。無法簽署。請聯絡管理員。",
    "Certificate validation could not be completed. Signing is not allowed." : "無法驗證憑證。無法簽署。",
    ...
    "Invalid signature box size. Width and height must be at least %.0f." : "無效的簽署框大小。寬度與高度必須至少 %.0f。",
    ...
    "Define the certificate engine to use" : "定義要使用的憑證引擎",
    "Run occ libresign:configure:%s --help" : "執行 occ libresign:configure:%s --help",
    "Certificate engine is configured correctly" : "憑證引擎設定正確",
    "Imagick PHP extension" : "PHP 的 Imagick 擴充元件",
    "Imagick extension is not loaded" : "Imagick 擴充元件未載入",
    "Install php-imagick to enable visible signatures, background images, and signature element rendering." : "安裝 php-imagick 以啟用可見簽章、背景影像與簽章元素的繪製。",
    "Imagick extension is loaded" : "Imagick 擴充元件已載入",
    "JSignPdf not found" : "找不到 JSignPdf",
    "Run %s" : "執行 %s",
    "JSignPdf file not found: %s" : "找不到 JSignPdf 檔案：%s",
    "Necessary Java to run JSignPdf" : "執行 JSignPdf 所需的 Java 版本",
    "Necessary install the version %s" : "必須安裝版本 %s",
    "JSignPdf must be updated from version %s to %s" : "JSignPdf 必須從版本 %s 更新至 %s",
    "JSignPdf must be downgraded from version %s to %s" : "JSignPdf 必須從版本 %s 降級至 %s",
    "JSignPdf version: %s" : "JSignPdf 版本：%s",
    "JSignPdf path: %s" : "JSignPdf 路徑：%s",
    "Java not installed" : "未安裝 Java",
    "Run occ libresign:install --java" : "執行 occ libresign:install --java",
    "Java binary not found: %s" : "找不到 Java 二進位檔案：%s",
    "Failed to execute Java. Sounds that your operational system is blocking the JVM." : "執行 Java 失敗。您的作業系統似乎正在阻擋 JVM。",
    "Failure to check Java version." : "檢查 Java 版本失敗。",
    "Invalid java version. Found: %s expected: %s" : "無效的 java 版本。找到：%s，預期為：%s",
    "Java encoding not found." : "找不到 Java 編碼。",
    "Non-UTF-8 encoding detected: %s. This may cause issues with accented or special characters" : "偵測到非 UTF-8 編碼：%s。這可能會導致帶有重音符號或特殊字元的文字出現問題",
    "Java version: %s" : "Java 版本：%s",
    "Java binary: %s" : "Java 二進位檔案：%s",
    "PDFtk not found" : "找不到 PDFtk",
    "Run occ libresign:install --pdftk" : "執行 occ libresign:install --pdftk",
    "PDFtk binary not found: %s" : "找不到 PDFtk 二進位檔案：%s",
    "Necessary Java to run PDFtk" : "執行 PDFtk 所需的 Java 版本",
    "Failure to check PDFtk version." : "檢查 PDFtk 版本失敗。",
    "PDFtk binary is invalid: %s" : "PDFtk 二進位檔案無效：%s",
    "PDFtk version: %s" : "PDFtk 版本：%s",
    "PDFtk path: %s" : "PDFtk 路徑：%s",
    "pdfsig version: %s, pdfinfo version: %s" : "pdfsig 版本：%s，pdfinfo 版本：%s",
    "Install the package poppler-utils on your operating system to enable PDF signature validation and page dimension detection." : "請在您的作業系統上安裝 poppler-utils 軟體包，以啟用 PDF 簽名驗證及頁面尺寸偵測功能。",
    "pdfsig not installed or not working" : "pdfsig 未安裝或無法運作",
    "pdfinfo not installed or not working" : "pdfinfo 未安裝或無法運作",
    "Binary integrity signature data not found." : "找不到二進位完整性簽章資料。",
    "It looks like this LibreSign instance is running from source code.\nEnable debug mode by running %s" : "看來這個 LibreSign 站台是從原始碼打包而來的。\n請執行 %s 以啟用除錯模式",
    "Binary integrity signature data is empty." : "二進位完整性簽章資料是空的。",
    "Invalid hash of binaries files." : "無效的二進位檔案雜湊值。",
    "Debug mode is enabled at your config.php and your LibreSign app was signed using a production signature. If you are not working at development of LibreSign, disable your debug mode or run the command: occ libresign install --%s --use-local-cert" : "您的 config.php 已啟用除錯模式，且您的 LibreSign 應用程式是使用正式環境簽名進行簽署的。如果您並非正在進行 LibreSign 的開發工作，請停用除錯模式，或執行此命令：occ libresign install --%s --use-local-cert",
    "Check your nextcloud.log file on %s and run occ libresign:install --all" : "請於 %s 檢查您的 nextcloud.log 檔案，並執行 occ libresign:install --all",
    "Check your nextcloud.log file and run occ libresign:install --all" : "請檢查您的 nextcloud.log 檔案，並執行 occ libresign:install --all",
    ...
    "Failed to save signature request" : "儲存簽章請求失敗",
    "Failed to load signer details" : "載入簽署者詳細資訊失敗",
    "Signer request not found" : "找不到簽署者請求",
    ...
    "Loading signer details …" : "正在載入簽署者詳細資訊……",
    "Add signer" : "新增簽署者",
    "Sign in order" : "簽署順序",
    ...
    "CRL: Certificate revoked before signing (revocation date: {revokedAt})" : "CRL：憑證於簽署前已被撤銷（撤銷日期：{revokedAt}）",
    ...
    "Timestamp authority details" : "時間戳授權機構詳細資訊",
    "Collapse timestamp authority details" : "折疊時間戳授權機構詳細資訊",
    "Expand timestamp authority details" : "展開時間戳授權機構詳細資訊",
    "Authority:" : "機構：",
    "Generated at:" : "產生於：",
    "Policy:" : "政策：",
    "Serial number:" : "序號：",
    ...
    "Unable to send verification code." : "無法傳送驗證碼。",
    ...
    "Signing is blocked until the certificate validation issue is resolved." : "在憑證驗證問題解決前，無法簽署。",
    "Try signing again" : "再次嘗試簽署",
    "Unable to sign." : "無法登入。",
    ...
    "Failed to add files to envelope" : "新增檔案至信封失敗",
    "File removed from envelope" : "已從信封移除檔案",
    "Files removed from envelope" : "已從信封移除檔案",
    ...
    "Underline" : "底線",
    "Failed to request signature" : "請求簽章失敗",
    "Failed to request signatures" : "請求簽章失敗",
    ...
    "Certificate Revocation (CRL)" : "憑證撤銷 (CRL)",
    "Controls external CRL validation when signing with personal certificates." : "控制使用個人憑證簽署時對外部憑證撤銷清單的驗證。",
    "Validate external CRL Distribution Points" : "驗證外部 CRL 散佈點",
    "The PHP LDAP extension is not installed. Users with certificates that use LDAP-based CRL Distribution Points will not be able to sign documents." : "未安裝 PHP LDAP 擴充套件。若憑證使用以 LDAP 為基礎的 CRL 散佈點，相關使用者將無法簽署文件。",
    "External CRL validation is disabled. Revocation of certificates from external authorities will not be checked. Certificates issued by LibreSign are not affected." : "外部 CRL 驗證已停用。將不會檢查來自外部憑證機構的憑證撤銷狀態。由 LibreSign 核發的憑證不會受影響。",
