OC.L10N.register(
    ...
    "Collect signers metadata when signing a document" : "簽署文件時蒐集簽署者詮釋資料",
    "Collect signers metadata" : "蒐集簽署者的詮釋資料",
    "Enabling this feature, everytime a document is signed, LibreSign will store the IP address and user agent of the signer." : "如果啟用此功能，LibreSign 將在簽署文件時儲存簽署者的 IP 與使用者代理字串。",
    "Message" : "訊息",
    "Resource" : "資源",
    "Advice" : "建議",
