OC.L10N.register(
    ...
    "Empty file" : "空檔案",
    "Inform URL or base64 or fileID to sign" : "通知 URL、base64 或檔案 ID 以簽署",
    ...
    "Page need be a integer type" : "頁面必須為整數",
    "Element need a type" : "元素需要類型",
    "Invalid element type" : "無效元素類型",
    "Must be a fileID of a PDF" : "必須為 PDF 的檔案 ID",
    ...
    "Submit Request" : "遞交請求",
    "Account" : "帳號",
    "Enter your password to sign this document" : "輸入您的密碼以簽署此文件",
    "You need to create a password to sign this document. Click \"Create password to sign document\" and create a password." : "您必須建立密碼以簽署此文件。點擊「建立密碼來簽署文件」並建立密碼。",
    ...
    "Feature {feature} enabled." : "功能 {feature} 已啟用。",
    "This feature does not exist." : "此功能不存在。",
    "This feature is already enabled." : "此功能已啟用。",
    "Feature enabled." : "功能已啟用。",
    "This feature is not enabled." : "此功能未啟用。",
