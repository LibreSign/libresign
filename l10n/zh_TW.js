OC.L10N.register(
    ...
    "Empty identify data." : "空的識別資料。",
    "Do not use mixed identify data." : "不要使用混合的識別資料。",
    ...
    "File sharing" : "檔案分享",
    "There is a file for you to sign" : "您有一份檔案需要簽署",
    ...
    "Signatures" : "簽章",
    "Search signer by account" : "按帳號搜尋簽署者",
    "Name" : "名稱",
    "No recommendations. Start typing." : "無建議。開始輸入。",
    "Account is mandatory" : "必須有帳號",
    "Searching …" : "正在搜尋……",
    "No elements found." : "找不到元素。",
    "E-mail of signer" : "簽署者的電子郵件",
    ...
    "Certificate engine to generate the root certificate" : "用來產生根憑證的憑證引擎",
    ...
    "Allow account creation for new users" : "允許新使用者建立帳號",
    "Allows sending registration email when the user does not have an account." : "當使用者沒有帳號時，允許傳送註冊電子郵件。",
    "Default signature method" : "預設簽署方法",
    ...
    "Collect signers metadata when sign a document" : "簽署文件時蒐集簽署者的詮釋資料",
    "Collect signers metadata" : "蒐集簽署者的詮釋資料",
