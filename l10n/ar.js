OC.L10N.register(
    ...
    "LibreSign: Changes into a file for you to sign" : "تطبيق LibreSign: التغييرات في ملف يلزم عليك القيام بالتوقيع عليه",
    ...
    "Root certificate has not been configured by the Administrator!" : "لم يتم تكوين شهادة الجذر/ الدليل الأساسي من قبل المسؤول!",
    ...
    "Regenerate root certificate" : "إعادة إنشاء شهادة الجذر/ الدليل الأساسي root certificate",
    ...
    "To generate new signatures, you must first generate the root certificate." : "لإنشاء توقيعات جديدة ، يجب أولاً إنشاء شهادة الجذر/ الأساسية.",
    ...
    "Open in LibreSign" : "فتح في تطبيق التوقيع الرقمي LibreSign",
