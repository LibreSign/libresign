OC.L10N.register(
    ...
    "Enable identification documents flow" : "تمكين دفق وثائق الهوية",
    "Identification documents" : "وثائق الهوية",
    "The flow of identification documents will make it mandatory for anyone who must sign a file, send identification documents to be approved by some member of the approval group. The user can only create the certificate after approval of the identification documents." : "دفق وثائق الهوية سيجعلها إلزامية لأي شخص يلزم قيامه بالتوقيع على ملف، ويرسل وثائق الهوية ليتم اعتمادها من قبل بعض أعضاء مجموعة الاعتماد. ويمكن للمستخدم إنشاء الشهادة فقط بعد الموافقة على وثائق الهوية.",
