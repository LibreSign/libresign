OC.L10N.register(
    ...
    "Inform or UUID or a File object" : "إبلاغ أو UUID أو كائن ملف",
    ...
    "Empty identify data." : "محو البيانات التعريفية.",
    "Do not use mixed identify data." : "لا تستعمل بيانات تعريفية مختلطة.",
    ...
    "Search signer by account" : "البحث عن صاحب التوقيع بدلالة حسابه",
    "Name" : "الاسم",
    "No recommendations. Start typing." : "لا توجد توصيات. إبدأ الكتابة.",
    "Account is mandatory" : "الحساب إلزامي",
    "Searching …" : "البحث جارٍ …",
    "No elements found." : "لم يتم العثور على أي عناصر",
    "E-mail of signer" : "البريد الالكتروني لصاحب التوقيع",
    "Please enter an email address." : "رجاءً، أدخِل عنوان بريد الكتروني.",
    "Update" : "تحديث",
    "Description" : "الوصف",
    "Add" : "إضافة",
    "Users" : "المستخدمين:",
    ...
    "Allow account creation for new users" : "السماح بإنشاء حسابات للمستخدمين الجديد",
    "Allows sending registration email when the user does not have an account." : "السماح بإرسال رسالة بريد إلكتروني للتسجيل إذا كان المستخدم لا يمتلك حساباً.",
    "Default signature method" : "طريقة التوقيع التلقائية",
