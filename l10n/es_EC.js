OC.L10N.register(
    ...
    "Failed to send code." : "Fallo al enviar el código.",
    "draft" : "borrador",
    ...
    "File type: %s. Specify a URL, a base64 string or a fileID." : "Tipo de archivo: %s. Especifica una URL, una cadena base64 o un ID de archivo.",
    ...
    "Coordinate %s must be equal to or greater than 0" : "La coordenada %s debe ser igual o mayor que 0",
    ...
    "Authorize signing using %s token is disabled because Nextcloud Two-Factor Gateway is not enabled." : "La autorización para firmar usando el token %s está deshabilitada porque la Pasarela de Autenticación de Dos Factores de Nextcloud no está habilitada.",
    ...
    "Are you sure you want to exclude user {email} from the request?" : "¿Estás seguro de que deseas excluir al usuario {email} de la solicitud?",
    ...
    "You need to create an account with the same email you received the invitation" : "Necesitas crear una cuenta con el mismo correo electrónico que recibiste en la invitación",
    ...
    "Next" : "Siguiente",
    "Set a password to sign the document" : "Establecer una contraseña para firmar el documento",
    "Password for sign document." : "Contraseña para firmar el documento.",
    "Create password to sign document" : "Crear contraseña para firmar el documento",
    "Do you want to create your signature and initials now?" : "¿Deseas crear tu firma e iniciales ahora?",
    "Yes" : "Sí",
    "No" : "No",
    "Congratulations, you have created your account. Please wait, we will redirect you to the requested signature file." : "Felicidades, has creado tu cuenta. Por favor espera, te redireccionaremos al archivo de firma solicitado.",
    ...
    "Subscription generated and available at {path}!" : "¡Suscripción generada y disponible en {ruta}!",
    ...
    "Enter the emails that will receive the request" : "Ingresa los correos electrónicos que recibirán la solicitud",
    "Signatures for this document have already been requested" : "Las firmas de este documento ya han sido solicitadas",
    ...
    "Binaries required to work. Download size could be nearly 340MB, please wait a moment." : "Binarios necesarios para trabajar. La descarga podría ocupar aproximadamente 340MB, por favor espera un momento.",
    ...
    "Do you want to configure visible elements in this document?" : "¿Deseas configurar elementos visibles en este documento?",
    "Request signatures?" : "¿Solicitar firmas?",
    "Element created" : "Elemento creado",
    "Select each signer to define their signature positions" : "Selecciona a cada firmante para definir sus posiciones de firma",
    ...
    "Do not use code when signing method is with password." : "No uses un código cuando el método de firma es con contraseña.",
    "Remove duplicated users, email address need to be unique" : "Eliminar usuarios duplicados, la dirección de correo electrónico debe ser única",
    "Validate File" : "Validar archivo",
    "Add visible signatures" : "Agregar firmas visibles",
    "Nothing to do" : "Nada que hacer",
    "Validate Document" : "Validar documento",
    "Collect signers metadata when sign a document" : "Recopilar metadatos de los firmantes al firmar un documento",
    "Collect signers metadata" : "Recopilar metadatos de los firmantes",
    "Enabling this feature, every when sign a document, LibreSign will store the IP, and user agent of signer." : "Al habilitar esta función, cada vez que un documento se firma, LibreSign almacenará la dirección IP y el agente de usuario del firmante",
    "Binaries required to work. Could be near by 340Mb to download, wait a moment." : "Binarios necesarios para trabajar. La descarga podría ocupar aproximadamente 340 MB, por favor espera un momento.",
