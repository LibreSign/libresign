OC.L10N.register(
    "libresign",
    {
    "{from} requested your signature on {file}" : "{from} بولسا {file} ئۈچۈن ئىمزايىڭىزنى تەلەپ قىلدى",
    "{from} canceled the signature request for {file}" : "{from} بولسا {file} نىڭ ئىمزا تەلىپىنى ئەمەلدىن قالدۇردى",
    "{from} signed {file}" : "{from} بولسا {file} غا ئىمزا قويدى",
    ...
    "A signature request has been <strong>canceled</strong>" : "بىر ئىمزا تەلىپى <strong>ئەمەلدىن قالدى</strong>",
    ...
    "File type: %s. Specify a URL, a Base64 string or a fileID." : "ھۆججەت تىپى: %s. بىر ئۇلىنىش تەمىنلەڭ، Base64 تىزمىسى ياكى fileID نى بەلگىلەڭ.",
    "File type: %s. Invalid fileID." : "ھۆججەت تىپى:%s. ئىناۋەتسىز ھۆججەت ID.",
    "File type: %s. Specify a URL, Base64 string, path or a fileID." : "ھۆججەت تىپى: %s. بىر ئۇلىنىش تەمىنلەڭ، Base64 تىزمىسى، يول ياكى fileID نى بەلگىلەڭ.",
    ...
    "This document has been certified with no changes allowed. You cannot add more signers to this document." : "بۇ ھۆججەت ھېچقانداق ئۆزگەرتىشكە يول قويۇلمىغان ھالدا تەستىقلاندى، شۇڭا قوشۇمچە ئىمزا قوشۇشقا بولمايدۇ.",
    ...
    "WhatsApp" : "WhatsApp",
    "XMPP" : "XMPP",
    "LibreSign: A signature request has been canceled" : "LibreSign: بىر ئىمزا تەلىپى ئەمەلدى قالدۇرۇلدى",
    "Signature request canceled" : "ئىمزا تەلىپى ئەمەلدى قالدۇرۇلدى",
    "The request for you to sign \"%s\" has been canceled." : "سىزگە \"%s\" غا ئىمزا قۇيۇش تەلىپى ئەمەلدىن قالدۇرۇلدى.",
    ...
    "Configure the content displayed at the footer of the PDF. The text template uses Twig syntax: https://twig.symfony.com/" : "PDF نىڭ بەت پۇتىدا كۆرسىتىلگەن مەزمۇننى تەڭشەڭ. تېكىست قېلىپى Twig سىنتاكسىسنى قوللىنىدۇ: https://twig.symfony.com/",
    ...
    "Custom message" : "ئىختىيارى ئۇچۇر",
    "Add a personal message for this signer" : "بۇ ئىمزالىغۇچ ئۈچۈن بىر شەخسىي ئۇچۇر قوش",
    "Update" : "يېڭىلا",
    "Name" : "ئاتى",
    "Please enter signer name." : "ئىمزا قويغۇچى نامىنى كىرگۈزۈڭ.",
    "This signer cannot be used because the identification method \"{method}\" has been disabled by the administrator." : "بۇ ئىمزا قويغۇچىنى ئىشلەتكىلى بولمايدۇ، چۈنكى «{method}» ئېنىقلاش ئۇسۇلى باشقۇرغۇچى تەرىپىدىن چەكلىنىپ قويۇلغان.",
    "Add custom message" : "ئىختىيارى ئۇچۇر قوش",
    ...
    "Some signers use identification methods that have been disabled. Please remove or update them before requesting signatures." : "بەزى ئىمزا قويغۇچىلار چەكلەنگەن ئېنىقلاش ئۇسۇللىرىنى ئىشلىتىدۇ. ئىمزا تەلەپ قىلىشتىن بۇرۇن ئۇلارنى ئۆچۈرۈڭ ياكى يېڭىلاڭ.",
    "Add signer" : "ئىمزا قويغۇچى قوشۇڭ",
    "View signing order" : "ئىمزا رەت-تەرتىپىنى كۆرسەت",
    "Signing order" : "بۇيرۇققا ئىمزا قويۇش",
    "Customize message" : "ئۇچۇرنى خاسلاشتۇر",
    ...
    "Signing order diagram" : "ئىمزا رەت-تەرتىپ دىئاگراممىسى",
    ...
    "_Document has %n revision_::_Document has %n revisions_" : ["ھۆججەتنىڭ %n نۇسخىسى بار","ھۆججەتنىڭ %n نۇسخىسى بار"],
    ...
    "Certificate {number}" : "گۇۋاھنامە {number}",
    ...
    "Binaries required to work. Download size could be nearly {size}, please wait a moment." : "ئىككىلىك خىزمەت قىلىش تەلەپ قىلىنىدۇ. چۈشۈرۈش چوڭلۇقى {size} غا يېقىن بولۇشى مۇمكىن ، سەل ساقلاپ تۇرۇڭ.",
    ...
    "_{count} file_::_{count} files_" : ["{count} ھۆججەت","{count} ھۆججەتلەر"],
    "Today" : "بۈگۈن",
    ...
    "Custom template" : "ئىختىيارى قېلىپ",
    ...
    "{from} made changes on {file}" : "{from} بولسا {file} غا ئۆزگەرتىش كىرگۈزدى",
    ...
    "Set default signing order" : "سۈكۈتتىكى ئىمزا رەت-تەرتىپىنى بەلگىلە",
    ...
    "Configure the content displayed with the signature. The text template uses Twig syntax: https://twig.symfony.com/" : "ئىمزا بىلەن كۆرسىتىلگەن مەزمۇننى تەڭشەڭ. تېكىست قېلىپى Twig سىنتاكسىسنى قوللىنىدۇ: https://twig.symfony.com/",
