OC.L10N.register(
    ...
    "Failed to send code." : "Pošiljanje kode je spodletelo.",
    "draft" : "osnutek",
    ...
    "No signers." : "Ni določenih podpisnikov.",
    ...
    "Yes" : "Da",
    "No" : "Ne",
    "Congratulations, you have created your account. Please wait, we will redirect you to the requested signature file." : "Račun je uspešno ustvarjen. Počakajte, da bo povezava preusmerjena na datoteko podpisa.",
    ...
    "Binaries required to work. Download size could be nearly 340MB, please wait a moment." : "Programske datoteke, nujne za delovanje, zasedejo okoli 340 MB prostora, zato je postopek namestitve lahko dolgotrajen.",
    ...
    "Binaries downloaded" : "Programske datoteke so uspešno prejete.",
    ...
    "You need to create an account with the same email you received the invitation" : "Račun je treba ustvariti z vpisom elektronskega naslova, na katerega je prispelo vabilo",
    ...
    "Signatures for this document have already been requested" : "Zahteva za podpisovanje tega dokumenta je že začeta.",
