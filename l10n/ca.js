OC.L10N.register(
    ...
    "Signature created!::_Elements created with success_" : ["Element creat amb èxit","Elements creats amb èxit"],
    ...
    "Password to sign the document." : "Contrasenya per signar el document.",
    ...
    "Document Information" : "Informació del document",
    "Validate Signature." : "Valida la subscripció.",
    ...
    "File type: %s. Inform URL or base64 or fileID." : "Tipus de fitxer: %s. Informeu l'URL o base64 o ID de fitxer.",
    "Allowed to sign document" : "Permès signar document",
    ...
    "Organization Unit (OU)" : "Unitat organitzativa (OU)",
    "To validate signature of the documents" : "Per validar la signatura dels documents",
    "Collect signers metadata when sign a document" : "Recolliu metadades dels signants quan signeu un document",
