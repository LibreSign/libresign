OC.L10N.register(
    ...
    "Inform or UUID or a File object" : "Informar ou UUID ou um objeto de Arquivo",
    ...
    "No initials, click here to create a new" : "Sem iniciais, clique aqui para criar novas",
    "The flow of identification documents will make it mandatory for anyone who must sign a file, send identification documents to be approved by some member of the approval group. The user can only create the certificate after approval of the identification documents." : "O fluxo de documentos de identificação tornará obrigatório que qualquer pessoa que precise assinar um arquivo envie documentos de identificação para serem aprovados por algum membro do grupo de aprovação. O usuário só poderá criar o certificado após a aprovação dos documentos de identificação.",
    "Not mandatory, don't fill to use default value." : "Não obrigatório, não preencha para usar o valor padrão.",
    "To validate signature of the documents. Only change this value if you want to replace the default validation URL by other." : "Para validar a assinatura dos documentos. Somente altere este valor se quiser substituir o URL de validação padrão por outro."
},
