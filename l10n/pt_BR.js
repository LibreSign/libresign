OC.L10N.register(
    ...
    "After signing, only form filling is allowed." : "Após a assinatura, só é permitido preencher o formulário.",
    ...
    "Request signers to submit identification documents before certificate issuance." : "Solicite aos signatários que apresentem documentos de identificação antes da emissão do certificado.",
    ...
    "Supported in preview: headings, bold, italic, lists, blockquotes, code, links and horizontal rules." : "Recursos suportados na visualização: títulos, negrito, itálico, listas, citações em bloco, código, links e linhas horizontais.",
