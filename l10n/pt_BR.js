OC.L10N.register(
    ...
    "not LibreSign file" : "não é um arquivo LibreSign",
    "draft" : "esboço",
    ...
    "Digest mismatch." : "Incompatibilidade de digest",
    ...
    "Invalid template font size. The value must be between %.1f and %.0f." : "Tamanho da fonte no modelo inválido. O valor deve estar entre %.1f e %.0f.",
    "Invalid signature font size. The value must be between %.1f and %.0f." : "Tamanho de fonte de assinatura inválido. O valor deve estar entre %.1f e %.0f.",
    ...
    "Date when the signer sent the request to sign (without time, in their local time zone)." : "Data em que o signatário enviou a solicitação de assinatura (sem hora, em fuso horário local dele).",
    "Date and time when the signer send the request to sign (in their local time zone)." : "Data e hora em que o signatário enviou a solicitação de assinatura (em fuso horário local dele).",
    "Time zone of signer when send the request to sign (in their local time zone)." : "Fuso horário do signatário em que ele enviou a solicitação de assinatura (em fuso horário local dele).",
    "Date and time when the signature was applied on the server. Cannot be formatted using Twig." : "Data e hora em que a assinatura foi aplicada no servidor. Não pode ser formatado usando o Twig.",
    ...
    "Enabling this feature, every time a document is signed, LibreSign will store the IP address and user agent of the signer." : "Ao ativar esse recurso, toda vez que um documento for assinado, o LibreSign armazenará o endereço IP e o agente do usuário do signatário.",
    ...
    "Expiration in days" : "Vencimento em dias",
    ...
    "Signer name and description" : "Nome do signatório e descrição",
    "Signature only" : "Somente assinatura",
    "Reset to default" : "Redefinir para o padrão",
    "Signature text template" : "Modelo de texto de assinatura",
    ...
    "Full name of states or provinces" : "Nome completo dos estados ou províncias",
