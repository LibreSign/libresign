OC.L10N.register(
    ...
    "Search by serial number..." : "Pesquisar por número de série…",
    ...
    "CRL URLs inaccessible" : "URLs da CRL inacessíveis",
    "CRL validation failed" : "A validação da CRL falhou.",
    "CRL validation error" : "Erro de validação CRL",
    ...
    "No date" : "Sem data",
    "Collapse details" : "Colapsar Detalhes",
    "Expand details" : "Expandir detalhes",
    "Requested on:" : "Solicitada em:",
    "Validation status" : "Status da validação",
    "Validation status, expanded. Click to collapse" : "Status da validação, expandido. Clique para recolher.",
    "Validation status, collapsed. Click to expand" : "Status de validação, recolhido. Clique para expandir.",
    "Collapse validation status" : "Recolher o estado de validação",
    "Expand validation status" : "Expandir status de validação",
    "Validation status details" : "Detalhes do status da validação",
    "Valid at signing time" : "Válido no momento da assinatura.",
    "NOT valid at signing time" : "NÃO é válido no momento da assinatura.",
    ...
    "Timestamp Authority" : "Autoridade de carimbo de data/hora",
    "Timestamp Authority, expanded. Click to collapse" : "Autoridade de carimbo de data/hora, expandida. Clique para recolher.",
    "Timestamp Authority, collapsed. Click to expand" : "Autoridade de carimbo de data/hora, colapsou. Clique para expandir",
    ...
    "Timestamp Authority details" : "Detalhes da Autoridade de Carimbo de Data/Hora",
    "TSA:" : "TSA:",
    "Time:" : "Horário:",
