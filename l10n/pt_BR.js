OC.L10N.register(
    ...
    "This document has been certified with no changes allowed, so no additional signatures can be added." : "Este documento foi certificado sem permissão para alterações, portanto, nenhuma assinatura adicional pode ser adicionada.",
    ...
    "Folder already exists and is not empty: %s" : "Pasta já existe ou não está vazia: %s",
