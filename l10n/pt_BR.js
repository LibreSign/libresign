OC.L10N.register(
    ...
    "draft" : "esboço",
    "able to sign" : "pronto para assinar",
    ...
    "Empty identify data." : "Dados de identificação vazios.",
    "Do not use mixed identify data." : "Não use dados de identificação mistos.",
    ...
    "**This is a libre digital PDF signature app for Nextcloud**\n\n* ✍️ Sign PDF documents using digital signature" : "**Este é um aplicativo de assinatura digital PDF gratuito para Nextcloud**\n\n* ✍️ Assine documentos PDF usando assinatura digital",
    ...
    "Search signer by account" : "Pesquisar assinante por conta",
    "Name" : "Nome",
    "No recommendations. Start typing." : "Sem recomendações. Começe a digitar.",
    "Account is mandatory" : "A conta é obrigatória",
    "Searching …" : "Pesquisando...",
    "No elements found." : "Nenhum elemento encontrado.",
    "E-mail of signer" : "E-mail do signatário",
    ...
    "Certificate engine to generate the root certificate" : "Mecanismo de certificado para gerar o certificado raiz",
    ...
    "Binaries required to work. Download size could be nearly 340MB, please wait a moment." : "Binários são necessários para prosseguir. O tamanho pode chegar a 340MB, por favor aguarde um momento.",
    ...
    "Binaries downloaded" : "Binários baixados",
    ...
    "Allow account creation for new users" : "Permitir a criação de conta para novos usuários",
    "Allows sending registration email when the user does not have an account." : "Permite o envio de e-mail de cadastro quando o usuário não possui conta.",
    "Default signature method" : "Método de assinatura padrão",
    "Identify factors" : "Identificar fatores",
    ...
    "Add visible signatures" : "Adicionar assinaturas visíveis",
