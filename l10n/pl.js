OC.L10N.register(
    ...
    "LibreSign" : "LibreSign",
    "Changes into a file for you to sign" : "Zmienia się w plik do podpisania",
    ...
    "The signature request has been cancelled." : "Prośba o podpis została anulowana.",
    ...
    "Inform URL or base64 to sign" : "Poinformuj adres URL lub base64, aby podpisać",
    ...
    "Remove duplicated users, email need to be unique" : "Usuń zduplikowanych użytkowników, e-maile muszą być unikalne",
    "Document already signed" : "Dokument już podpisany",
    "No signature was requested to %s" : "Nie zażądano podpisu do %s",
    "User need to be email: user %s" : "Użytkownik musi mieć adres e-mail: użytkownik %s",
    ...
    "Sorry but the page you are looking for does not exist, have been removed, name changed or is temporarily unavailable." : "Strona, której szukasz, nie istnieje, została usunięta, zmieniona nazwa lub jest chwilowo niedostępna.",
    ...
    "Signed document available on {place}" : "Podpisany dokument dostępny w {place}",
