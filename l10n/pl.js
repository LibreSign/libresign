OC.L10N.register(
    ...
    "Insufficient permissions to use API" : "Niewystarczające uprawnienia do korzystania z API",
    ...
    "Organizational Unit (OU)" : "Jednostka organizacyjna (OU):",
    "Signature storage." : "Przechowywanie podpisów.",
    "Select folder where signature will be saved." : "Wybierz katalog, w którym zostanie zapisany podpis.",
    ...
    "Choose a folder to store your signature!" : "Wybierz katalog do przechowywania podpisu!",
    "Signature location." : "Lokalizacja podpisu.",
    "Select signature file location." : "Wybierz lokalizację pliku podpisu.",
    "Select signature." : "Wybierz podpis.",
    "Signature password." : "Hasło podpisu.",
    "Signed document available at {place}" : "Podpisany dokument dostępny w {place}",
    "Could not sign document!" : "Nie udało się podpisać dokumentu!",
