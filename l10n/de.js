OC.L10N.register(
    ...
    "Date and time when the signer send the request to sign (in their local time zone)." : "UnterzeichnerDatum und Uhrzeit, zu der der Unterzeichner die Signaturanforderung gesendet hat (in seiner lokalen Zeitzone).",
    "Time zone of signer when send the request to sign (in their local time zone)." : "Zeitzone des Unterzeichners beim Senden der Signaturanforderung (in seiner lokalen Zeitzone).",
    ...
    "Signature stamp" : "Unterschriftenstempel",
