OC.L10N.register(
    ...
    "Sign »%s«" : "Signiere »%s«",
    "LibreSign: There is a file for you to sign" : "LibreSign: Eine Datei zum Signieren vorhanden",
    ...
    "Select authorized groups that can request to sign documents. Admin group is the default group and don't need to be defined." : "Wähle autorisierte Gruppen aus, die das Signieren von Dokumenten anfordern können. Die Admin-Gruppe ist die Standardgruppe und muss nicht definiert werden.",
    ...
    "LibreSign is developed with ❤️ by LibreCode coop. Your support helps us maintain and improve this free and open-source project." : "LibreSign wird mit ❤️ von LibreCode coop entwickelt. Ihre Unterstützung hilft uns, dieses freie und quelloffene Projekt zu pflegen und zu verbessern.",
    "Sponsor on GitHub" : "Auf GitHub sponsern",
    "Donate via Stripe" : "Per Stripe spenden",
