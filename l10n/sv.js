OC.L10N.register(
    ...
    "_Element created with success_::_Elements created with success_" : ["Element skapades","Element skapades"],
    ...
    "Failed to send code." : "Misslyckades att skicka kod.",
    "draft" : "utkast",
    ...
    "LibreSign" : "LibreSign",
    "✍️ Libre digital signature app for Nextcloud" : "✍️ Fri digital signeringsapp för Nextcloud",
    "**This is a libre digital PDF signature app for Nextcloud**\n\n* ✍️ Sign PDF documents using digital signature" : "**Detta är en fri digital PDF-signeringsapp för Nextcloud**\n\n* ✍️ Signera PDF-dokument med digital signatur",
    "Back to sign" : "Tillbaka till signering",
    "Request" : "Begäran",
    "Files" : "Filer",
    "Validate" : "Validera",
    ...
    "Initials" : "Initialer",
    "No initials, click here to create a new" : "Inga initialer, klicka här för att skapa en ny",
    ...
    "Create new subscription." : "Skapa en ny prenumeration.",
    "Root certificate has not been configured by the Administrator!" : "Rotcertifikatet har inte konfigurerats av administratören!",
    ...
    "See Document Validation" : "Se dokumentvalidering",
    ...
    "Generate Subscription." : "Generera prenumeration.",
    "Subscription generated and available at {path}!" : "Prenumeration genererad och tillgänglig på {path}!",
    "Could not create signature." : "Kunde inte skapa signatur.",
    ...
    "Binaries required to work. Download size could be nearly 340MB, please wait a moment." : "Binärfiler som krävs för att fungera. Nedladdningsstorleken kan vara nästan 340 MB, vänta ett ögonblick.",
    ...
    "The flow of identification documents will make it mandatory for anyone who must sign a file, send identification documents to be approved by some member of the approval group. The user can only create the certificate after approval of the identification documents." : "Flödet av identifieringshandlingar kommer att göra det obligatoriskt för alla som måste underteckna en fil, skicka identifieringsdokument för att godkännas av någon medlem i godkännandegruppen. Användaren kan bara skapa certifikatet efter godkännande av identifieringsdokumenten.",
    ...
    "Identify factors" : "Identifiera faktorer",
    ...
    "To validate signature of the documents. Only change this value if you want to replace the default validation URL by other." : "För att validera dokumentens signatur. Ändra endast detta värde om du vill ersätta standardverifierings-URL med en annan.",
    "Validation URL" : "Validerings-URL",
    "Signature tab" : "Signaturflik",
    "Loading …" : "Läser in …",
    ...
    "File type: %s. Specify a URL, a base64 string or a fileID." : "Filtyp: %s. Ange en URL, en Base64-sträng eller ett filID.",
    "File type: %s. Invalid base64 file." : "Filtyp: %s. Ogiltig Base64-fil.",
    "Coordinate %s must be equal to or greater than 0" : "Koordinat %s måste vara lika med eller större än 0",
    "Do not use code when signing method is with password." : "Använd inte kod när signeringsmetoden är med lösenord.",
    "You must not sign this file." : "Du får inte signera den här filen.",
    "Page not found." : "Sidan hittades inte.",
    "Remove duplicated users, email address need to be unique" : "Ta bort dubblerade användare, e-postadressen måste vara unik",
    "%s is your LibreSign verification code." : "%s är din LibreSign verifieringskod.",
    "Authorize signing using %s token is disabled because Nextcloud Two-Factor Gateway is not enabled." : "Auktorisera signering med %s-token är inaktiverat eftersom Nextcloud Two-Factor Gateway inte är aktiverad.",
    "Gateway %s not configured on Two-Factor Gateway." : "Gateway %s inte konfigurerad på Two-Factor Gateway.",
    "Colors:" : "Färger:",
    "Apply" : "Tillämpa",
    "Validate File" : "Validera fil",
    "Signatures" : "Signaturer",
    "Add visible signatures" : "Lägg till synliga signaturer",
    "Are you sure you want to exclude user {email} from the request?" : "Är du säker på att du vill utesluta användaren {email} från begäran?",
    "Description" : "Beskrivning",
    "Add" : "Lägg till",
    "Users" : "Användare",
    "Submit Request" : "Skicka begäran",
    "Password & Security" : "Lösenord & Säkerhet",
    "Create password key" : "Skapa lösenordsnyckel",
    "Reset password" : "Återställ lösenord",
    "Select a file" : "Välj en fil",
    "You need to create an account with the same email you received the invitation" : "Du måste skapa ett konto med samma e-postadress som du fick inbjudan",
    "Set a password to sign the document" : "Ange ett lösenord för att signera dokumentet",
    "Password for sign document." : "Lösenord för att signera dokument.",
    "Create password to sign document" : "Skapa lösenord för att signera dokumentet",
    "Do you want to create your signature and initials now?" : "Vill du skapa din signatur och initialer nu?",
    "Congratulations, you have created your account. Please wait, we will redirect you to the requested signature file." : "Du har skapat ditt konto. Vänta, vi omdirigerar dig till den begärda signaturfilen.",
    "Nothing to do" : "Inget att göra",
    "Validate Document" : "Validera dokument",
    "Do you want to configure visible elements in this document?" : "Vill du konfigurera synliga element i detta dokument?",
    "Enter the emails that will receive the request" : "Ange e-postadresser som kommer att ta emot begäran",
    "Signatures for this document have already been requested" : "Begäran om signaturer för detta dokument har redan begärts",
    "Add users" : "Lägg till användare",
    "Advice" : "Råd",
    "Define custom values to use CFSSL" : "Definiera anpassade värden att använda CFSSL",
    "Root certificate data." : "Rotcertifikatdata.",
    "Generate root certificate." : "Generera rotcertifikat.",
    "Element created" : "Element skapat",
    "Remove" : "Ta bort",
    "This iframe is not supported in your browser." : "Denna iframe stöds inte i din webbläsare.",
    "%s is not a valid sign method" : "%s är inte en giltig signeringsmetod.",
    "Document Informations" : "Dokumentinformation",
    "Validate Subscription." : "Validera prenumeration.",
