OC.L10N.register(
    ...
    "Renewed with success. Access the link again." : "Rinnovato correttamente. Accedi nuovamente al collegamento.",
    ...
    "%s signed the document. You can access it using the link below:" : "%s firmato il documento. È possibile accedervi tramite il collegamento sottostante:",
    ...
    "Link expired" : "Collegamento scaduto",
    "The link to sign the document has expired.\nWe will send a new link to the email %1$s.\nClick below to receive the new link and be able to sign the document." : "Il collegamento per firmare il documento è scaduto.\nInvieremo un nuovo collegamento all'email %1$s.\nFai clic qui sotto per ricevere il nuovo collegamento e poter firmare il documento.",
    "Renew" : "Rinnovare",
    "Account" : "Account",
    ...
    "{seconds} seconds left" : "{seconds} secondi rimanenti",
    ...
    "Signature" : "Firma",
    "No signature, click here to create a new one" : "Nessuna firma, fai clic qui per crearne una nuova",
    "Initials" : "Iniziali",
    "No initials, click here to create a new one" : "Nessuna iniziale, fai clic qui per crearne una nuova",
    ...
    "Renewal interval in seconds of a subscription request. When accessing the link, you will be asked to renew the link." : "Intervallo di rinnovo in secondi di una richiesta di iscrizione. Quando accedi al collegamento, ti ​​verrà chiesto di rinnovare il collegamento.",
