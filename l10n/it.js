OC.L10N.register(
    ...
    "Signature created!::_Elements created with success_" : ["Elemento creato con successo","Elementi creati con successo","Elementi creati con successo"],
    ...
    "draft" : "bozza",
    "Available for Signature" : "in grado di firmare",
    ...
    "Signature" : "Firma",
    "No signature, click here to create a new" : "Nessuna firma, clicca qui per crearne una",
    "Initials" : "Iniziali",
    "No initials, click here to create a new" : "Nessuna iniziale, clicca qui per crearne una",
    ...
    "You need to create an account with the same email address you received the invitation" : "Devi creare un account con la stessa email con cui hai ricevuto l'invito",
    ...
    "Password to sign the document." : "Password per firmare il documento.",
