OC.L10N.register(
    ...
    "Insufficient permissions to use API" : "Permessi insufficienti per usare l'API",
    "Name is mandatory" : "Il nome è obbligatorio",
    "The name can only contain \"a-z\", \"A-Z\", \"0-9\" and \"-_\" chars." : "Il nome può contenere solo caratteri \"a-z\", \"A-Z\", \"0-9\" e \"-_\".",
    ...
    "Could not generate certificate." : "Generazione certificato fallita.",
    "Webhook" : "Webhook",
    ...
    "Organizational Unit (OU)" : "Unità organizzativa (OU)",
    "Signature storage." : "Archiviazione della firma.",
    "Select folder where signature will be saved." : "Seleziona la cartella dove verrà salvata la firma.",
    ...
    "Could not create signature." : "Creazione della firma fallita.",
    "Choose a folder to store your signature!" : "Scegli una cartella per salvare la tua firma!",
    "Signature location." : "Posizione della firma.",
    "Select signature file location." : "Seleziona la posizione del file di firma.",
    "Select signature." : "Seleziona firma.",
    "Signature password." : "Password firma.",
