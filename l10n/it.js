OC.L10N.register(
    ...
    "Date and time when the signer send the request to sign (in their local time zone)." : "Data e ora in cui il firmatario invia la richiesta di firma (nel fuso orario locale).",
    "Time zone of signer when send the request to sign (in their local time zone)." : "Fuso orario del firmatario al momento dell'invio della richiesta di firma (nel fuso orario locale).",
