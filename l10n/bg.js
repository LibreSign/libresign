OC.L10N.register(
    ...
    "Insert Signature and/or Initials" : "Вмъкване на подпис и/или инициали",
    "Return" : "Връщане ",
    "Email" : "Имейл",
    ...
    "Account" : "Профил",
    "Enter your password to sign this document" : "Въведете паролата си, за да подпишете този документ",
    "You need to create a password to sign this document. Click \"Create password to sign document\" and create a password." : "Трябва да създадете парола, за да подпишете този документ. Кликнете върху „Създаване на парола за подписване на документ“ и създайте парола.",
    "Details" : "Подробности",
    ...
    "Pending" : "Чакащ",
    "Signed" : "Подписан",
    "There was an error completing your request" : "Възникна грешка при изпълнението на заявката ви",
    "Request subscription" : "Заявка за абонамент",
    "Verify signatures" : "Проверка на подписите",
    ...
    "This feature already exists." : "Тази функция вече съществува.",
    "Feature {feature} enabled." : "Функцията {feature} е активирана.",
    "This feature does not exist." : "Тази функция не съществува.",
    "This feature is already enabled." : "Функцията вече е активирана.",
    "Feature enabled." : "Функцията е активирана.",
    "This feature is not enabled." : "Тази функция не е активирана.",
    "Feature disabled." : "Функцията е изключена.",
