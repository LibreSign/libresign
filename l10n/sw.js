OC.L10N.register(
    ...
    "{from} canceled the signature request for {file}" : "{from} canceled the signature request for {file}",
    ...
    "A signature request has been <strong>canceled</strong>" : "A signature request has been <strong>canceled</strong>",
    "Success" : "Mafanikio",
    ...
    "Object outside the page margin" : "Object outside the page margin",
    ...
    "LibreSign: A signature request has been canceled" : "LibreSign: A signature request has been canceled",
    "Signature request canceled" : "Signature request canceled",
    "The request for you to sign \"%s\" has been canceled." : "The request for you to sign \"%s\" has been canceled.",
    ...
    "_{count} file_::_{count} files_" : ["{count} file","{count} faili"],
    "Today" : "Leo",
