OC.L10N.register(
    ...
    {
    "Success" : "성공",
    "Invalid user or password" : "잘못된 유저 또는 암호",
    ...
    "No signers." : "서명자 없음.",
    "You must not sign this file." : "이 파일에 서명하면 안 됩니다.",
    ...
    "File type: %s. Inform URL or base64 or fileID." : "파일 형식: %s URL 또는 base64 또는 fileID를 알려주십시오.",
    ...
    "Authorize signing using %s token is disabled because Nextcloud Two-Factor Gateway is not enabled." : "Nextcloud Two-Factor Gateway가 사용하도록 설정되어 있지 않기 때문에 %s토큰을 사용한 인증 서명을 사용할 수 없습니다.",
    ...
    "This action requires you to confirm your password" : "이 작업을 수행하려면 암호를 확인해야 합니다.",
    "Password" : "암호",
    "Confirm" : "확인",
    ...
    "Create new subscription." : "새 헤드라인 등록을 만듭니다.",
    "Root certificate has not been configured by the Administrator!" : "관리자가 루트 인증서를 구성하지 않았습니다!",
    "You need to create an account with the same email you received the invitation" : "초대를 받은 것과 동일한 전자 메일로 계정을 만들어야 합니다.",
    "Your password must be greater than 4 digits" : "비밀번호는 4자리 이상이어야 합니다.",
    ...
    "Yes" : "예",
    "No" : "아니오",
    "Congratulations, you have created your account. Please wait, we will redirect you to the requested signature file." : "축하합니다. 계정이 생성되었습니다. 잠시 기다려 주십시오. 요청하신 서명 파일로 리디렉션해 드리겠습니다.",
    ...
    "See Document Validation" : "문서 확인 참조",
    ...
    "Generate Subscription." : "구독을 생성합니다.",
    "Subscription generated and available at {path}!" : "구독이 생성되어 {path}에서 사용 가능합니다!",
    "Could not create signature." : "서명을 작성할 수 없습니다.",
    "Request Signatures" : "서명 요청",
    "Choose the file to request signatures." : "서명을 요청할 파일을 선택하십시오.",
    "Choose from Files" : "파일에서 선택",
    "Enter the emails that will receive the request" : "요청을 받을 전자 메일을 입력하십시오.",
    "Signatures for this document have already been requested" : "이 문서에 대한 서명이 이미 요청되었습니다.",
    "Add users" : "유저 추가",
    ...
    "Create your password for signing PDF" : "PDF에 서명하기 위한 암호 만들기",
    ...
    "You do not have any sign defined." : "정의된 기호가 없습니다."
},
"nplurals=1; plural=0;");
