OC.L10N.register(
    ...
    "Signature created!::_Elements created with success_" : ["성공적으로 생성된 요소"],
    ...
    "You need to create an account with the same email address you received the invitation" : "초대를 받은 것과 동일한 전자 메일로 계정을 만들어야 합니다.",
