OC.L10N.register(
    ...
    "Empty identify data." : "Datos de identificación baleiros.",
    "Do not use mixed identify data." : "Non use datos de identificación mixtos.",
    ...
    "Search signer by account" : "Busca asinante por conta",
    "Name" : "Nome",
    "No recommendations. Start typing." : "Non hai recomendacións. Comece a escribir.",
    "Account is mandatory" : "A conta é obrigatoria",
    "Searching …" : "Buscando…",
    "No elements found." : "Non se atoparon elementos.",
    "E-mail of signer" : "Correo do asinante",
    "Please enter an email address." : "Introduza un enderezo de correo-e.",
    "Update" : "Actualizar",
    ...
    "Certificate engine to generate the root certificate" : "Motor de certificados para xerar o certificado raíz",
    ...
    "Allow account creation for new users" : "Permitir a creación de contas para novos usuarios",
    "Allows sending registration email when the user does not have an account." : "Permitir enviar o correo de rexistro cando o usuario non ten unha conta.",
    "Default signature method" : "Método de sinatura predeterminado",
    ...
    "Collect signers metadata when sign a document" : "Recoller metadatos dos asinantes ao asinar un documento",
