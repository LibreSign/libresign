OC.L10N.register(
    ...
    "Invalid worker type. Use \"local\" or \"external\"." : "Tipo de traballador do servizo non válido. Empregue «local» ou «externo».",
    ...
    "Certificate has been revoked" : "O certificado foi revogado",
    "Cannot reach the certificate revocation service. Signing is not allowed." : "Non é posible contactar co servizo de revogación de certificados. Non está permitido asinar.",
    "An error occurred during certificate validation. Signing is not allowed." : "Produciuse un erro durante a validación do certificado. Non está permitido asinar.",
    "Certificate validation failed. Signing is not allowed. Contact your administrator." : "A validación do certificado fallou. Non está permitido asinar. Contacta co teu administrador.",
    "This certificate has no revocation URLs. Signing is not allowed. Contact your administrator." : "Este certificado non ten URLs de revogación. Non está permitido asinar. Contacta co teu administrador.",
    "This certificate has no revocation information. Signing is not allowed. Contact your administrator." : "Este certificado non ten información de revogación. Non está permitido asinar. Contacta co teu administrador.",
    "Certificate validation could not be completed. Signing is not allowed." : "Non foi posible completar a validación do certificado. Non está permitido asinar.",
    ...
    "Invalid signature box size. Width and height must be at least %.0f." : "Tamaño da caixa de sinatura non válido. O ancho e o alto deben ser polo menos %.0f.",
    ...
    "Date and time when the signature was applied on the server (ISO 8601 format). Can be formatted using the Twig date filter." : "Data e hora en que se aplicou a sinatura no servidor (formato ISO 8601). Pódese formatar usando o filtro de data de Twig.",
    ...
    "Validation URL of the signed document." : "URL de validación do documento asinado.",
    "Base64-encoded PNG QR code for the validation URL. In HTML/Twig, use <img src=\"data:image/png;base64,{{ qrcode }}\">. In plain-text templates, use {{ValidationURL}}." : "Código QR en PNG codificado en base64 para a URL de validación. En HTML/Twig, usa <img src=\"data:image/png;base64,{{ qrcode }}\">. En modelos de texto plano, usa {{ValidationURL}}.",
    ...
    "Control document signing workflows inside Nextcloud" : "Controla os fluxos de traballo de sinatura de documentos dentro de Nextcloud",
    "**LibreSign helps organizations manage document signing inside Nextcloud.**\n\nIt is built for teams that need clear signing rules, traceable actions, and workflows that follow internal processes and legal requirements.\n\n**What LibreSign enables**\n\n- Define signing order and signer roles\n- Support internal and external signers\n- Keep a traceable record of requests and validations\n- Use digital certificates for compliant signing workflows\n- Validate documents using QR codes\n- Work directly with Nextcloud files and users\n- Integrate signing with other systems through APIs\n\n**Support LibreSign**\nIf your organization uses LibreSign, support its development:\n\n[![Sponsor](https://img.shields.io/static/v1?label=Sponsor&message=%E2%9D%A4&logo=GitHub&color=%23fe8e86)](https://github.com/sponsors/libresign)\n\nFor enterprise support, contact LibreCode:\nhttps://libresign.coop" : "**LibreSign axuda ás organizacións a xestionar a sinatura de documentos dentro de Nextcloud.**\n\nEstá deseñado para equipos que necesitan regras de sinatura claras, accións rastrexables e fluxos de traballo que seguen procesos internos e requisitos legais.\n\n**O que permite LibreSign**\n\n- Definir a orde de sinatura e os roles dos asinantes\n- Admitir asinantes internos e externos\n- Manter un rexistro rastrexable de solicitudes e validacións\n- Usar certificados dixitais para fluxos de sinatura conformes coa normativa\n- Validar documentos mediante códigos QR\n- Traballar directamente con ficheiros e usuarios de Nextcloud\n- Integrar a sinatura con outros sistemas a través de APIs\n\n**Apoiar LibreSign**\nSe a túa organización usa LibreSign, apoia o seu desenvolvemento:\n\n[![Patrocinar](https://img.shields.io/static/v1?label=Sponsor&message=2%9D4&logo=GitHub&color=e8e86)](https://github.com/sponsors/libresign)\n\nPara soporte empresarial, contacta con LibreCode:\nhttps://libresign.coop",
    ...
    "Delete" : "Eliminar",
    "Drawing area. Use a mouse or touch screen to draw your signature. If you cannot draw, use the Text or Upload tabs instead." : "Área de debuxo. Usa o rato ou a pantalla táctil para debuxar a túa sinatura. Se non podes debuxar, usa as pestanas Texto ou Subir no seu lugar.",
    "Draw your signature here" : "Debuxa aquí a túa sinatura",
    ...
    "Undo" : "Desfacer",
    "Redo" : "Refacer",
    "Document {docNumber} of {totalDocs} ({docName}), page {pageNumber} of {totalPages}. Press Enter or Space to place the signature here." : "Documento {docNumber} de {totalDocs} ({docName}), páxina {pageNumber} de {totalPages}. Preme Intro ou Espazo para colocar a sinatura aquí.",
    "Document {docNumber} of {totalDocs} ({docName}), page {pageNumber} of {totalPages}." : "Documento {docNumber} de {totalDocs} ({docName}), páxina {pageNumber} de {totalPages}.",
    "Page {pageNumber} of {totalPages}. Press Enter or Space to place the signature here." : "Páxina {pageNumber} de {totalPages}. Preme Intro ou Espazo para colocar a sinatura aquí.",
    "Page {pageNumber} of {totalPages}." : "Páxina {pageNumber} de {totalPages}.",
    "{currentPage} of {totalPages}" : "{currentPage} de {totalPages}",
    "Duplicate" : "Duplicar",
    "Signature position for {name}" : "Posición da sinatura para {name}",
    "Signature preview" : "Vista previa da sinatura",
    "Loading …" : "Cargando…",
    "Name" : "Nome",
    "Update" : "Actualizar",
    ...
    "Failed to save signature request" : "Produciuse un fallo ao gardar a solicitude de sinatura",
    "Failed to load signer details" : "Produciuse un fallo ao cargar os detalles do asinante",
    "Signer request not found" : "Solicitude do asinante non atopada",
    "Failed to send reminder" : "Produciuse un fallo ao enviar o recordatorio",
    "Signature requested" : "Sinatura solicitada",
    "Failed to request signature" : "Produciuse un fallo ao solicitar a sinatura",
    "Failed to request signatures" : "Produciuse un fallo ao solicitar as sinaturas",
    ...
    "Signer {name} (already signed)" : "Asinante {name} (xa asinado)",
    "Edit signer {name}" : "Editar asinante {name}",
    "Identification method: {method}" : "Método de identificación: {method}",
    "Signer status: {status}" : "Estado do asinante: {status}",
    ...
    "Signer certificate" : "Certificado do asinante",
    ...
    "CRL: Certificate revoked before signing (revocation date: {revokedAt})" : "CRL: Certificado revogado antes da sinatura (data de revogación: {revokedAt})",
    "CRL: Certificate revoked before signing" : "CRL: Certificado revogado antes da sinatura",
    "CRL: Valid at signing time (revocation date: {revokedAt})" : "CRL: Válido no momento da sinatura (data de revogación: {revokedAt})",
    "CRL: Valid at signing time" : "CRL: Válido no momento da sinatura",
    "Collapse details of {signerName}" : "Contraer os detalles de {signerName}",
    "Expand details of {signerName}" : "Expandir os detalles de {signerName}",
    ...
    "Collapse timestamp authority details" : "Contraer os detalles da autoridade de selo de tempo",
    "Expand timestamp authority details" : "Expandir os detalles da autoridade de selo de tempo",
    "Timestamp Authority (TSA)" : "Autoridade de Datado Dixital (TSA polas siglas en inglés)",
    "Timestamp authority details" : "Detalles da autoridade de selo de tempo",
    "Authority:" : "Autoridade:",
    "Generated at:" : "Xerado o:",
    "Policy:" : "Política:",
    "Serial number:" : "Número de serie:",
    "Signed on" : "Asinado o",
    ...
    "Resource" : "Recurso",
    "Tip" : "Consello",
    "Certificate Revocation (CRL)" : "Revogación de Certificados (CRL)",
    "Controls external CRL validation when signing with personal certificates." : "Controla a validación externa de CRL ao asinar con certificados persoais.",
    "Validate external CRL Distribution Points" : "Validar os Puntos de Distribución de CRL externos",
    "The PHP LDAP extension is not installed. Users with certificates that use LDAP-based CRL Distribution Points will not be able to sign documents." : "A extensión PHP LDAP non está instalada. Os usuarios con certificados que usan Puntos de Distribución de CRL baseados en LDAP non poderán asinar documentos.",
    "External CRL validation is disabled. Revocation of certificates from external authorities will not be checked. Certificates issued by LibreSign are not affected." : "A validación externa de CRL está desactivada. Non se comprobará a revogación de certificados de autoridades externas. Os certificados emitidos por LibreSign non se ven afectados.",
    ...
    "Native" : "Nativo",
    "Signature engine" : "Motor de sinatura",
    "Select the signature engine to sign the documents" : "Selecciona o motor de sinatura para asinar os documentos",
    ...
    "Error saving parallel workers configuration." : "Produciuse un erro ao gardar a configuración dos traballadores do servizo en paralelo.",
    ...
    "Use external worker service" : " Empregar o traballador do servizo externo",
    "You must manage and keep the external worker running manually." : "Debe xestionar e manter o traballador do servizo externo funcionando manualmente.",
    "Nextcloud manages the background worker automatically." : "Nextcloud xestiona o traballador do servizo en segundo plano automaticamente.",
    "Configure how many background workers should process signing jobs in parallel. More workers increase throughput but consume more resources. Valid range: 1-32." : "Configure cantos traballadores do servizo en segundo plano deben procesar traballos de sinatura en paralelo. Máis traballadores aumentan o rendemento mais consumen máis recursos. Intervalo válido: 1-32.",
    ...
    "Code validation" : "Validación do código",
    ...
    "Enter your contact information" : "Introduce a túa información de contacto",
    ...
    "Signing is blocked until the certificate validation issue is resolved." : "A sinatura está bloqueada ata que se resolva o problema de validación do certificado.",
    "Try signing again" : "Tentar asinar de novo",
    "Sign the document." : "Asinar o documento.",
    "Unable to sign." : "Non é posíbel asinar.",
    "Confirm that you want to sign this document." : "Confirma que queres asinar este documento.",
    "Enter your signature password to sign the document." : "Introduce o contrasinal da túa sinatura para asinar o documento.",
    "Signature password" : "Contrasinal de sinatura",
    ...
    "Signature: Unknown" : "Sinatura: Descoñecida",
    ...
    "Failed to add files to envelope" : "Produciuse un fallo ao engadir ficheiros ao sobre",
    "File removed from envelope" : "Ficheiro eliminado do sobre",
    "Files removed from envelope" : "Ficheiros eliminados do sobre",
    "Failed to remove file(s) from envelope" : "Produciuse un fallo ao eliminar ficheiro(s) do sobre",
    "Requested by {name}, at {date}" : "Solicitado por {name}, o {date}",
    "Hello {name}" : "Ola {name}",
    "_{count} file_::_{count} files_" : ["{count} ficheiro","{count} ficheiros"],
    "Signed by {name}" : "Asinado por {name}",
    "Signing" : "Asinando",
