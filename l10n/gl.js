OC.L10N.register(
    ...
    "Authorize signing using %s token is disabled because Nextcloud Two-Factor Gateway is not enabled." : "A autorización de sinatura mediante o testemuño %s está desactivada porque  a Pasarela para a verificación de dous factores de Nextcloud non está activada.",
    "Gateway %s not configured on Two-Factor Gateway." : "Gateway %s non configurado na Pasarela para a verificación de dous factores.",
    ...
    "Binaries required to work. Download size could be nearly 340MB, please wait a moment." : "Binarios necesarios para funcionar. O tamaño da descarga pode ser de case 340 MB, agarde un chisco.",
    ...
    "Binaries required to work. Could be near by 340Mb to download, wait a moment." : "Binarios son necesarios para funcionar. É necesario descargar preto de 340 Mb, agarde un chisco."
},
