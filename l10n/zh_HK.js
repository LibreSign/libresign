OC.L10N.register(
    ...
    "You need to create an account with the same email address you received the invitation from." : "您需要使用您收到邀請的電郵地址創建一個賬戶。",
    ...
    "Unable to sign." : "無法簽署。",
    "{signatureMethod} is not a valid sign method" : "{signatureMethod} 不是有效的簽署方法",
    "All Files" : "所有檔案",
    "Pending" : "待定的",
    "Signed" : "已簽署",
