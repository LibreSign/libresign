OC.L10N.register(
    ...
    "File type: %s. Specify a URL, base64 string, path or a fileID." : "檔案類型：%s。指定 URL、base64 字串、途徑或 fileID。",
    ...
    "Empty identify data." : "空的識別數據。",
    "Do not use mixed identify data." : "請不要使用混合的身份識別數據。",
    ...
    "**This is a libre digital PDF signature app for Nextcloud**\n\n* ✍️ Sign PDF documents using digital signature" : "**這是一個用於 NextCloud 的 Libre Digital PDF簽名應用應用程式**\n\n*✍️使用數字簽名簽署 PDF 文件",
    "Back to sign" : "回到簽署頁面",
    "Request" : "請求",
    "Files" : "檔案",
    "Validate" : "驗證",
    ...
    "Signatures" : "簽名",
    "Search signer by account" : "按賬戶搜尋簽署者",
    "Name" : "名字",
    "No recommendations. Start typing." : "沒有建議。開始輸入。",
    "Account is mandatory" : "必須有賬戶",
    "Searching …" : "正在搜尋……",
    "No elements found." : "找不到元素。",
    "E-mail of signer" : "簽署者電郵地址",
    "Please enter an email address." : "請輸入電郵地址",
    "Update" : "更新",
    "Description" : "描述",
    "Add" : "添加",
    "Users" : "用戶",
    ...
    "Welcome to Libresign" : "歡迎來到 Libresign",
    ...
    "Dependencies" : "相關性",
    "Binaries required to work. Download size could be nearly 340MB, please wait a moment." : "需要可執行檔才能運作。下載大小可能接近 340MB，請稍候片刻。",
    ...
    "Allow account creation for new users" : "允許新用戶創建賬戶",
    "Allows sending registration email when the user does not have an account." : "當用戶沒有賬戶時，允許發送註冊郵件。",
    "Default signature method" : "默認簽名方法",
    "Identify factors" : "識別因素",
