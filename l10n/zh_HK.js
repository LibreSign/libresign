OC.L10N.register(
    ...
    "Insert Signature and/or Initials" : "插入簽名和/或姓名首字母",
    "Return" : "返回",
    "Email" : "電郵地址",
    "Description" : "描述",
    "Add" : "添加",
    ...
    "Select each signer to define theirs signature positions" : "選擇每個簽名者來定義他們的簽名位置",
    "Remove" : "移除",
    "Previous" : "上一步",
    "Create your signature" : "創建您的簽名",
    ...
    "This feature already exists." : "此特點已存在。",
    "Feature {feature} enabled." : "特點 {feature} 已啟用。",
    "This feature does not exist." : "此特點不存在",
    "This feature is already enabled." : "此特點已啟用。",
    "Feature enabled." : "特點已啟用。",
    "This feature is not enabled." : "此特點未啟用。",
    "Feature disabled." : "特點已停用。",
    "User created!" : "用戶創建了！",
