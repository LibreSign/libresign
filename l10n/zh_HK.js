OC.L10N.register(
    ...
    "Signatures" : "簽名",
    "Requested by {name}" : "由 {name} 請求",
    "User with no name" : "沒有名字的用戶",
    ...
    "Choose the file to request signatures." : "選擇檔案以請求簽名。",
    "Choose from Files" : "從檔案選取",
    "Enter the emails that will receive the request" : "輸入將接收請求的電郵地址",
    "Signatures for this document have already been requested" : "已要求簽名此文件",
    "Add users" : "新增用戶",
