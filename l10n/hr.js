OC.L10N.register(
    ...
    "_Element created with success_::_Elements created with success_" : ["Element je uspješno stvoren","Elementi su uspješno stvoreni","Elementi su uspješno stvoreni"],
    ...
    "You must not sign this file." : "Ne smijete potpisati ovu datoteku.",
    ...
    "File type: %s. Invalid base64 file." : "Vrsta datoteke: %s. Nevažeća datoteka base64.",
    ...
    "Coordinate %s must be equal to or greater than 0" : "Koordinata %s mora biti jednaka ili veća od 0",
    ...
    "Yes" : "Da",
    "No" : "Ne",
    "Congratulations, you have created your account. Please wait, we will redirect you to the requested signature file." : "Čestitamo, stvorili ste svoj račun. Pričekajte da vas preusmjerimo na traženu datoteku potpisa.",
