OC.L10N.register(
    ...
    "Insufficient permissions to use API" : "Permisos insuficientes para usar la API",
    "Name is mandatory" : "El nombre es obligatorio",
    "The name can only contain \"a-z\", \"A-Z\", \"0-9\" and \"-_\" chars." : "El nombre solo puede contener los caracteres: \"a-z\", \"A-Z\", \"0-9\" y \"-_\"",
    ...
    "Signature location." : "Ubicación de la firma.",
    "Select signature file location." : "Seleccione la ubicación del archivo de firma.",
    "Select signature." : "Seleccione la firma.",
    "Signature password." : "Contraseña de la firma.",
    "Signed document available at {place}" : "Documento firmado disponible en {place}",
    "Could not sign document!" : "¡No se pudo firmar el documento!",
    "Choose your subscription location!" : "¡Elija la ubicación de tu suscripción!",
