OC.L10N.register(
    ...
    "Element must be associated with an user" : "El elemento debe estar asociado a un usuario",
    ...
    "Authorize signing using %s token is disabled because Nextcloud Two-Factor Gateway is not enabled." : "La firma de autorización con el token %s está desactivada porque Nextcloud Two-Factor Gateway no está habilitado.",
    "Gateway %s not configured on Two-Factor Gateway." : "La puerta de enlace %s no está configurada en la puerta de enlace de dos factores.",
    ...
    "**This is a libre digital PDF signature app for Nextcloud**\n\n* ✍️ Sign PDF documents using digital signature" : "**Esta es una aplicación libre para firmas digitales PDF para Nextcloud**\n\n* ✍️ Firmar documentos PDF utilizando firmas digitales",
    ...
    "Your profile documents" : "Los documentos de su perfil",
    "Type" : "Tipo",
    "Status" : "Estado",
    "Actions" : "Acciones",
    ...
    "Allow request to sign" : "Permitir solicitud de firma",
    ...
    "Status of setup" : "Estado de la instalación",
    ...
    "Validate setup" : "Validar instalación",
    ...
    "To validate signature of the documents. Only change this value if you want to replace the default validation URL by other." : "Para validar la firma de los documentos. Solo cambie este valor si desea cambiar el URL de validación por defecto a otro.",
    ...
    "File type: %s. Inform URL or base64 or fileID." : "Tipo de archivo: %s. Informar la URL o base64 o fileID.",
    "Element must be associated with a user" : "El elemento debe estar asociado a un usuario",
    "**This is a libre digital PDF signature app for Nextcloud**\n\n* ✍️ Sign PDF documents using digital signature\n* ⚠️ Setup of this app requires access to terminal and even getting your hands dirty with installation of additional software. See [setup instructions](https://github.com/LibreSign/libresign/blob/main/README.md#setup) for details." : "**Esta es una aplicación libre para la firma digital de PDFs para Nextcloud**.\n\n* ✍️ Firma documentos PDF utilizando la firma digital\n* ⚠️ La configuración de esta app requiere acceso a un terminal e incluso ensuciarse las manos con la instalación de software adicional. Consulta las [instrucciones de configuración](https://github.com/LibreSign/libresign/blob/main/README.md#setup) para más detalles.",
    "Country (C)" : "País (C)",
    ...
    "Loading" : "Cargando",
    "Allowed to sign document" : "Tiene permitido firmar documento",
    "Tip" : "Tip",
    "Check configure" : "Verificar configuración",
    "Binaries required to work. Could be near by 340Mb to download, wait a moment." : "Binarios requeridos para el funcionamiento. El tamaño de la descarga es cercana a los 340MB, por favor, espere un momento."
},
