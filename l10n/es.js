OC.L10N.register(
    ...
    "Failed to load documents" : "Fallou ao cargar os documentos",
    "Failed to delete document" : "Fallou ao eliminar o documento",
    "No documents to validate" : "Non hai documentos para validar",
    ...
    "No documents found" : "Non se atoparon documentos",
    "1 file" : "1 archivo",
    ...
    "List of files. Column headers with buttons are sortable." : "Lista de ficheiros. As cabeceiras de columna con botóns son ordenables.",
    "Welcome to LibreSign" : "Bienvenido a LibreSign",
    "Finish the setup" : "Terminar la configuración",
    "Expires Soon" : "Caduca Proximamente",
    "Valid" : "Válido",
    "Valid (Not Revoked)" : "Válido (Non Revogado)",
    "No CRL Information" : "Sen Información de CRL",
    "No CRL URLs Found" : "Non se Atoparon URLs de CRL",
    "CRL URLs Inaccessible" : "URLs de CRL Non Accesibles",
    "CRL Validation Failed" : "Validación de CRL Fallida",
    "CRL Validation Error" : "Erro de Validación de CRL",
    ...
    "S/MIME Signing" : "Sinatura S/MIME",
    "S/MIME Encryption" : "Cifrado S/MIME",
    "CRL Signing" : "Sinatura de CRL",
    "Any Purpose" : "Calquera Finalidade",
    "OCSP Helper" : "Axudante OCSP",
    "Timestamp Signing" : "Sinatura de Marca de Tempo",
    ...
    "Certificate purposes" : "Finalidades do Certificado",
    "Allowed" : "Permitido",
    ...
    "Monitor documents currently being signed" : "Monitorizar os documentos que se están asinando actualmente",
    "Auto-refresh" : "Actualización automática",
    "Refresh" : "Refrescar",
    "No documents are currently being signed" : "Non se está asinando ningún documento actualmente",
    ...
    "PDF document to sign" : "Documento PDF para asinar",
    "Email verification" : "Verificación del correo electrónico",
    "Identity verification" : "Verificación de identidade",
    "Signature confirmation" : "Confirmación da sinatura",
    "Step 1 of 3 - Email verification" : "Paso 1 de 3 - Verificación por correo electrónico",
    "Step 1 of 3 - Identity verification" : "Paso 1 de 3 - Verificación de identidade",
    "Step 2 of 3 - Code validation" : "Paso 2 de 3 - Validación do código",
    ...
    "Your identity has been verified." : "A túa identidade foi verificada.",
    "You can now sign the document." : "Xa podes asinar o documento.",
