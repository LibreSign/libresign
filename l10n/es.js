OC.L10N.register(
    ...
    "Date and time when the signer send the request to sign (in their local time zone)." : "Fecha y hora en la cual el firmante envió la solicitud para firmar (en su zona horaria local).",
    "Time zone of signer when send the request to sign (in their local time zone)." : "Zona horaria del firmante cuando envió la solicitud para firmar (en su zona horaria local).",
    ...
    "Initials" : "Iniciales",
    "No initials, click here to create a new" : "Sin iniciales, haga clic aquí para crear una nueva",
    ...
    "The flow of identification documents will make it mandatory for anyone who must sign a file, send identification documents to be approved by some member of the approval group. The user can only create the certificate after approval of the identification documents." : "El flujo de documentos de identificación hará que sea obligatorio para todo aquel que deba firmar un archivo, el envío de documentos de identificación, los cuales deberán ser aprobados por algún miembro del grupo de aprobación. El usuario solo puede crear el certificado después de la aprobación de los mismos.",
    ...
    "Not mandatory, don't fill to use default value." : "No es obligatorio, déjelo en blanco para usar el valor por defecto.",
