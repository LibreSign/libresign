OC.L10N.register(
    ...
    "Empty identify data." : "Vaciar datos de identificación.",
    "Do not use mixed identify data." : "No utilizar datos de identificación mixtos.",
    ...
    "Signatures" : "Firmas",
    "Search signer by account" : "Buscar firmante por cuenta",
    "Name" : "Nombre",
    "No recommendations. Start typing." : "Sin recomendaciones. Empiece a escribir.",
    "Account is mandatory" : "La cuenta es obligatoria",
    "Searching …" : "Buscando  …",
    "No elements found." : "No se encontraron elementos.",
    "E-mail of signer" : "Correo electrónico del firmante",
    ...
    "Certificate engine to generate the root certificate" : "Motor de certificados a utilizar para generar el certificado raíz",
    ...
    "Allow account creation for new users" : "Permitir la creación de cuenta para usuarios nuevos",
    "Allows sending registration email when the user does not have an account." : "Permite el envío de correos de registro cuando el usuario no posee una cuenta.",
    "Default signature method" : "Método predeterminado de firma",
