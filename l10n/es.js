OC.L10N.register(
    ...
    "Signature created!::_Elements created with success_" : ["Elemento creado con éxito","Elementos creados con éxito","Elementos creados con éxito"],
    ...
    "draft" : "borrador",
    "Available for Signature" : "puede firmar",
    ...
    "Gateway %s not configured on Two-Factor Gateway." : "Gateway %s no configurado en Two-Factor Gateway.",
    ...
    "You need to create an account with the same email address you received the invitation" : "Tienes que crear una cuenta con el mismo correo electrónico en donde recibiste la invitación",
    ...
    "Password to sign the document." : "Contraseña para firmar documentos.",
    ...
    "Validate Signature." : "Validar Suscripción.",
    ...
    "Tip" : "Consejo",
    "Binaries required to work. Could be near by 340Mb to download, wait a moment." : "Binarios requeridos para el funcionamiento. El tamaño de la descarga es cercana a los 340MB, espere un momento.",
    "Country (C)" : "País (C)",
    ...
    "Collect signers metadata when sign a document" : "Recolectar metadatos de firmantes cuando se firme un documento",
    "Collect signers metadata" : "Recolectar metadatos de firmantes",
    "Enabling this feature, every when sign a document, LibreSign will store the IP, and user agent of signer." : "Al habilitar esta característica, cada vez que se firme un documento, se almacenará la dirección IP y el agente de usuario del firmante."
},
