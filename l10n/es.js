OC.L10N.register(
    ...
    "**This is a libre digital PDF signature app for Nextcloud**\n\n* ✍️ **Sign PDF** documents using digital certificates\n* 🔄 **Hybrid signatures**: You can choose between personal or system-generated digital certificates\n* 👥 **Multiple signers**: Request signature on a document for as many people as you need\n* 📸 **QR Code**: Document validation by QR Code\n* 🔒 **Privacy**: Fully self-hosted document signer\n* 📲 **Connect to your software**: Easily integrate [LibreSign](https://libresign.coop) into your service with our full-fledged\n* 🙋 **Get involved**! We have lots of stuff planned. More informations at [LibreSign](https://github.com/libresign/libresign) repository.\n\n🌍 Help us translate this application on [Transifex](https://app.transifex.com/nextcloud/nextcloud/libresign/)\n\nIf you enjoy this app and want to help maintain its development or want enterprise support, please contact us:\n\n[https://libresign.coop](https://libresign.coop)\n\n## Donation\n\nDeveloped with ❤️ by [LibreCode](https://librecode.coop). Help us transform people and businesses through cooperativism.\n\n* [Donate with GitHub Sponsor: ![Donate using GitHub Sponsor](https://img.shields.io/static/v1?label=Sponsor&message=%E2%9D%A4&logo=GitHub&color=%23fe8e86)](https://github.com/sponsors/libresign)" : "**Esta es una app libre de firmado PDF digital para Nextcloud**\n\n* ✍️ **Firme documentos PDF** utilizando certificados digitales\n* 🔄 **Firmas híbridas**: Puede escoger entre certificados personales o generados por el sistema\n* 👥 **Múltiples firmas**: Solicitar firma en un documento de cuantas personas necesite\n* 📸 **Código QR**: Validación de documentos a través de códigos QR\n* 🔒 **Privacidad**: Firmado de documentos totalmente auto-hospedado\n* 📲 **Conéctela a su software**: Pude integrar fácilmente [LibreSign](https://libresign.coop) a su servicio con nuestro\n* 🙋 ¡**Colabore**! Tenemos muchísimas cosas planeadas. Más información en el repositorio de [LibreSign](https://github.com/libresign/libresign).\n\n🌍 Ayúdenos a traducir esta aplicación en [Transifex](https://app.transifex.com/nextcloud/nextcloud/libresign/)\n\nSi disfruta esta app y quiere mantener su desarrollo, o desea soporte empresarial, por favor, contáctenos:\n\n[https://libresign.coop](https://libresign.coop)\n\n## Donaciones\n\nDesarrollado con ❤️ por [LibreCode](https://librecode.coop). Ayúdenos a transformar a las personas y a los negocios a través del cooperativismo.\n\n* [Haga una donación con GitHub Sponsor: ![Donar usando GitHub Sponsor](https://img.shields.io/static/v1?label=Sponsor&message=%E2%9D%A4&logo=GitHub&color=%23fe8e86)](https://github.com/sponsors/libresign)",
