OC.L10N.register(
    ...
    "Certificate is Trusted." : "El certificado es de Confianza.",
    "Signature is valid." : "La firma es válida.",
    "Signature is invalid." : "La firma no es válida.",
    "Digest mismatch." : "Desajuste en el resumen.",
    "Document isn't signed or corrupted data." : "El documento no está firmado o tiene datos corruptos.",
    ...
    "Certificate issuer isn't trusted." : "El emisor del certificado no es confiable.",
    ...
    "Unknown issue with Certificate or corrupted data." : "Problema desconocido con el certificado o datos dañados.",
    ...
    "Click on the place you want to add." : "Haz clic en el lugar que quieras agregar.",
    "Sign" : "Firmar",
    "Confirm" : "Confirmar",
