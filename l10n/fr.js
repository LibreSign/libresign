OC.L10N.register(
    ...
    "Signature created!::_Elements created with success_" : ["Élément créé avec succès","Élément créé avec succès","Éléments créés avec succès"],
    ...
    "draft" : "brouillon",
    "Available for Signature" : "capable de signer",
    ...
    "You need to create an account with the same email address you received the invitation" : "Vous devez créer le compte avec l'adresse e-mail sur laquelle vous avez reçu l'invitation",
    ...
    "Validate Signature." : "Valider l'abonnement.",
