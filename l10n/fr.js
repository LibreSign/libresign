OC.L10N.register(
    ...
    "%s-level scope is not supported for this policy" : "La portée au niveau %s n'est pas prise en charge pour cette politique.",
    ...
    "User-level scope is not supported for this policy" : "La portée au niveau utilisateur n'est pas prise en charge pour cette politique.",
    ...
    "Undo" : "Annuler",
    "Redo" : "Refaire",
    "Document {docNumber} of {totalDocs} ({docName}), page {pageNumber} of {totalPages}. Press Enter or Space to place the signature here." : "Document {docNumber}sur {totalDocs} ({docName}), page {pageNumber} sur {totalPages}. Appuyez sur Entrée ou sur Espace pour placer la signature ici.",
    ...
    "Step 1 of 3 - Email verification" : "Etape 1 sur 3 - Vérification de l'email",
    "Step 1 of 3 - Identity verification" : "Etape 1 sur 3 - Vérification de l'identité",
    "Step 2 of 3 - Code validation" : "Etape 2 sur 3 - Validation du code",
    "Step 3 of 3 - Signature confirmation" : "Etape 3 sur 3 - Confirmation de la signature",
    ...
    "Failed to add files to envelope" : "Echec de l'ajout des documents à l'enveloppe",
    "File removed from envelope" : "Document retiré de l'enveloppe",
    "Files removed from envelope" : "Document retirés de l'enveloppe",
    "Failed to remove file(s) from envelope" : "Echec du retrait du/des document(s) de l'enveloppe",
    ...
    "Able to sign" : "Document à signer",
    "Today" : "Aujourd’hui",
