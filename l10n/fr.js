OC.L10N.register(
    ...
    "Duplicate" : "Dupliquer",
    "Signature position for {name}" : "Position de la signature pour {name}",
    "Signature preview" : "Prévisualisation de la signature",
    "Loading …" : "Chargement …",
    "Name" : "Nom",
    "Update" : "Mise à jour",
    ...
    "Edit signer {name}" : "Editer signataire {name}",
    ...
    "Collapse details of {signerName}" : "Réduire les détails de {signerName}",
    "Expand details of {signerName}" : "Développer les détails de {signerName}",
