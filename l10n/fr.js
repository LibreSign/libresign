OC.L10N.register(
    ...
    "File type: %s. Specify a URL, a base64 string or a fileID." : "Fichier de type : %s. Renseignez une URL, une chaine en base64 ou un fileID.",
    ...
    "Authorize signing using %s token is disabled because Nextcloud Two-Factor Gateway is not enabled." : "Signer des documents avec le jeton %s est interdit car la passerelle d'authentification à facteurs multiples de NextCloud est désactivée.",
    "Gateway %s not configured on Two-Factor Gateway." : "La passerelle %s n'a pas été configurée dans les réglages de la passerelle d'authentification à facteurs multiples.",
    ...
    "**This is a libre digital PDF signature app for Nextcloud**\n\n* ✍️ Sign PDF documents using digital signature" : "**Ceci est une application Libre de signature numérique de PDF pour Nextcloud**\n\n* ✍️ Signez des documents PDF grâce à une signature numérique",
    "Back to sign" : "Retour à la signature",
    "Request" : "Requête",
    "Files" : "Fichiers",
    "Validate" : "Valider",
    ...
    "Search signer by account" : "Rechercher le signataire par son compte",
    "Name" : "Nom",
    "No recommendations. Start typing." : "Pas de suggestion. Commencez à écrire.",
    "Account is mandatory" : "Le compte est obligatoire",
    "Searching …" : "Recherche…",
    "No elements found." : "Aucun élément trouvé.",
    "E-mail of signer" : "Adresse e-mail du signataire",
    ...
    "You need to create an account with the same email you received the invitation" : "Vous devez créer le compte avec l'adresse e-mail sur laquelle vous avez reçu l'invitation",
    ...
    "Enter the emails that will receive the request" : "Saisissez les e-mails qui recevront les demandes",
    ...
    "Select authorized groups that can request to sign documents. Admin group is the default group and don't need to be defined." : "Sélectionnez les groupes autorisés à demander la signature de documents. Le groupe par défaut est Admin, il n'a pas besoin d'être définit.",
    ...
    "Customize default user folder" : "Paramétrer le répertoire par défaut de l'utilisateur",
    ...
    "Binaries required to work. Download size could be nearly 340MB, please wait a moment." : "Exécutables nécessaires au fonctionnement. La taille de téléchargement peut être proche de 340 Mo, merci de patienter un moment.",
    ...
    "Binaries downloaded" : "Exécutables téléchargés",
    ...
    "Allow account creation for new users" : "Permettre la création de comptes pour les nouveaux utilisateurs",
    "Default signature method" : "Méthode de signature par défaut ",
    ...
    "Loading …" : "Chargement …",
    "%s is not a valid sign method" : "%s n'est pas une méthode de signature valide.",
    ...
    "Do not use code when signing method is with password." : "N'utilisez pas de code lorsque la méthode de signature utilise un mot de passe.",
