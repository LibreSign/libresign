OC.L10N.register(
    ...
    "Binaries required to work. Download size could be nearly 340MB, please wait a moment." : "Exécutables nécessaires au fonctionnement. La taille du téléchargement peut être proche de 340 Mo, merci de patienter un moment.",
    ...
    "Allows sending registration email when the user does not have an account." : "Autorise l'envoi de courriel d'inscription lorsque l'utilisateur n'a pas de compte.",
    "Default signature method" : "Méthode de signature par défaut ",
    "Identify factors" : "Identifier les facteurs",
