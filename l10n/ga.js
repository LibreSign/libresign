OC.L10N.register(
    ...
    "Date and time when the signer send the request to sign (in their local time zone)." : "An dáta agus an t-am a sheolann an sínitheoir an t-iarratas ar shíniú (ina chrios ama áitiúil).",
    "Time zone of signer when send the request to sign (in their local time zone)." : "Crios ama an tsínitheora nuair a sheoltar an t-iarratas chun síniú (ina chrios ama áitiúil).",
