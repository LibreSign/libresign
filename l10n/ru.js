OC.L10N.register(
    ...
    "File type: %s. Inform URL or base64 or fileID." : "Тип файла: %s. Сообщите URL base64 или fileID.",
    "Select authorized groups." : "Выберите авторизованные группы.",
    "Country (C)" : "Страна (C)",
    "Organization (O)" : "Организация (О)",
    "Organization Unit (OU)" : "Подразделение (OU)",
    "To validate signature of the documents" : "Для проверки подписи документов"
},
