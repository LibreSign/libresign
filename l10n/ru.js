OC.L10N.register(
    ...
    "Allows sending registration email when the user does not have an account." : "Позволяет отправлять регистрационное письмо, когда у пользователя нет учетной записи.",
    ...
    "Binaries required to work. Could be near by 340Mb to download, wait a moment." : "Бинарники, необходимые для работы. Может быть около 340 МБ для загрузки, подождите минутку.",
    "Remove" : "Удалить"
},
