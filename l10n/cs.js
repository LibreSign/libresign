OC.L10N.register(
    ...
    "{from} canceled the signature request for {file}" : "{from} zrušil/a žádost o podpis pro {file}",
    ...
    "A signature request has been <strong>canceled</strong>" : "Požadavek o podpis byl <strong>zrušen</strong>",
    "Success" : "Úspěch",
    ...
    "Invalid signing mode. Use \"sync\" or \"async\"." : "Neplatný režim podepisování. Použijte „sync“ nebo “async“.",
    "Invalid worker type. Use \"local\" or \"external\"." : "Neplatný typ zpracovávajícího procesu. Použijte „local“ nebo „external“.",
    "Mode is required when signature flow is enabled." : "Pokud je zapnutý tok podpisů, je zapotřebí režim.",
    "Invalid signature flow mode. Use \"parallel\" or \"ordered_numeric\"." : "Neplatný režim toku podpisu. Použijte „parallel“ (souběžné) nebo „ordered_numeric“ (číselně řazené).",
    "Invalid DocMDP level" : "Neplatná úroveň DocMDP",
    "Internal error. Contact admin." : "Vnitřní chyba chyba – obraťte se na správce.",
    "This is not an envelope" : "Toto není obálka",
    "Cannot add files to an envelope that is not in draft status" : "Není možné přidat soubory do obálky která není ve stavu koncept",
    "No files uploaded" : "Nenahrány žádné soubory",
    "Envelope not found" : "Obálka nenalezena",
    "Failed to add file to envelope" : "Nepodařilo se přidat soubor do obálky",
    "File name is required" : "Je zapotřebí název souboru",
    "File or files parameter is required" : "Je zapotřebí soubor nebo parametr souboru",
    "Invalid UUID" : "Neplatný UUID identifikátro",
    "Invalid id-doc request" : "Neplatný id-doc požadavek",
    ...
    "Pending signatures" : "Čekající podpisy",
    "User not found" : "Uživatel nenalezen",
    "No pending signatures" : "Žádné čekající podpisy",
    "From: %s • Date: %s" : "Od: %s • Datum: %s",
    "From: %s" : "Od: %s",
    "View all documents" : "Zobrazit všechny dokumenty",
    "Identification Document" : "Identifikační doklad",
    "waiting for approval" : "čeká se na schválení",
    "approved" : "schváleno",
    "No certification" : "Žádná certifikace",
    "No changes allowed" : "Nedovoleny žádné změny",
    "Form filling allowed" : "Vyplňování formulářů povoleno",
    "Form filling and commenting allowed" : "Vyplňován formulářů a komentování dovoleno",
    "The document is not certified; edits and new signatures are allowed, but any change will mark previous signatures as modified." : "Dokument není certifikovaný – úpravy a nové podpisy jsou povoleny, ale jakékoli změny označí předchozí podpisy jako změněné.",
    "After the first signature, no further edits or signatures are allowed; any change invalidates the certification." : "Po prvním podpisu, nejsou povoleny žádné další úpravy – jakékoli změny certifikaci zneplatní.",
    "After the first signature, only form filling and additional signatures are allowed; other changes invalidate the certification." : "Po prvním podpisu, je povoleno pouze vyplnění formuláře a další podpisy – jakékoli jiné změny certifikaci zneplatní.",
    "After the first signature, form filling, comments, and additional signatures are allowed; other changes invalidate the certification." : "Po prvním podpisu, je povoleno vyplnění formuláře, komentáře a další podpisy – jakékoli jiné změny certifikaci zneplatní.",
    "Not LibreSign file" : "Není LibreSign soubor",
    "Draft" : "Koncept",
    "Ready to sign" : "Připraveno k podpisu",
    "Partially signed" : "Částečně podepsáno",
    "Signed" : "Podepsáno",
    "Deleted" : "Smazáno",
    "Signing in progress" : "Probíhá podepisování",
    "User not found." : "Uživatel nenalezen.",
    "Multiple DocMDP signatures detected. The first certifying signature determines the document's permission level." : "Zjištěno vícero DocMDP podpisů. Stupeň oprávnění dokumentu určuje první certifikující podpis.",
    ...
    "Text direction for the footer (ltr or rtl based on language)" : "Směr textu pro zápatí (zleva doprava nebo zprava doleva – dle jazyka)",
    "Link to LibreSign or custom website" : "Odkaz na LibreSign nebo uživatelsky určený web",
    "QR Code image in base64 format for document validation" : "Obrázek QR kódu (ve formátu base64) pro ověření dokumentu",
    "QR Code size in pixels (includes margin)" : "Velikost (v pixelech) QR kódu (včetně okrajů)",
    "Message indicating the document was digitally signed" : "Zpráva indikující že dokument byl digitálně podepsán",
    "Array of signers with \"displayName\" and \"signed\" timestamp" : "Pole podepisujících s „displayName“ (zobrazované jméno) a časovým razítkem „signed“ (podepsáno)",
    "Document unique identifier (UUID format)" : "Neopakující se identifikátor dokumentu (ve formátu UUID)",
    "Validation message template with placeholder" : "Šablona ověřovací zprávy (s výplní)",
    "Complete URL for document validation with UUID" : "Úplné URL pro ověřování dokumentu pomocí UUID",
    ...
    "You are not allowed to sign this document yet" : "Zatím ještě nemáte oprávnění podepsat tento dokument",
    ...
    "You need to have an approved identification document to sign." : "Aby bylo možné podepsat, je třeba mít schválený identifikační doklad.",
    "libresign" : "libresign",
    ...
    "This document has been certified with no changes allowed. You cannot add more signers to this document." : "Tento dokument byl certifikován tak, že nejsou dovoleny žádné změny. Není tak možné tomuto dokumentu přidávat další podepisující.",
    "Invalid file type" : "Neplatný typ souboru",
    "Envelope feature is disabled" : "Funkce obálky je vypnutá",
    "Maximum number of files per envelope (%s) exceeded" : "Nejvyšší umožněný počet souborů v jednotlivých obálkách (%s) překročen",
    "The specified ID is not an envelope" : "Zadaný identifikátor není obálka",
    "Cannot add files to an envelope that is already in signing process" : "Není možné přidávat soubory do obálky která už je v procesu podepisování",
    "No file source provided" : "Neposkytnut žádný zdroj souboru",
    "Pending" : "Čeká",
    ...
    "Unable to process the file as a PDF document: %s" : "Nebylo možné zpracovat soubor jako PDF dokument: %s",
    "The file \"%s\" is password-protected. Please remove the protection and try again." : "Soubor „%s“ je chráněn heslem. Odeberte tuto ochranu a zkuste to znovu.",
    "This document has been certified with no changes allowed, so no additional signatures can be added: %s" : "Tento dokument byl certifikován tak, že nejsou dovoleny žádné změny. Není tak možné tomuto dokumentu přidávat žádné další podpisy: %s",
    "Invalid file identifier" : "Neplatný identifikátor souboru",
    "No file provided" : "Neposkytnut žádný soubor",
    "Envelope folder not found" : "Složka obálky nenalezena",
    "Folder already exists and is not empty: %s" : "Složka už existuje a  není prázdná: %s",
    ...
    "SMS token" : "SMS token",
    "Telegram token" : "Token z Telegram",
    ...
    "WhatsApp token" : "Token z WhatsApp",
    ...
    "LibreSign: A signature request has been canceled" : "LibreSign: požadavek na podepsání byl zrušen.",
    "Signature request canceled" : "Požadavek na podpis zrušen",
    "The request for you to sign \"%s\" has been canceled." : "Žádost, abyste podepsali „%s“ byla zrušena.",
    ...
    "Invalid signer data" : "Neplatné údaje podepisujícího",
    "Envelope %s" : "Obálka %s",
    "Empty signers list" : "Prázdný seznam podepisujících",
    "Signers list needs to be an array" : "Je třeba, aby seznam podepisujících bylo pole",
    ...
    "Name must not exceed {max} characters" : "Je třeba, aby název nebyl delší než {max} znaků",
    "Cancel" : "Storno",
    "Save" : "Uložit",
    "Draw" : "Nakreslit",
    "Text" : "Text",
    ...
    "Delete" : "Smazat",
    "Drawing area. Use a mouse or touch screen to draw your signature. If you cannot draw, use the Text or Upload tabs instead." : "Oblast pro kreslení. Použijte myš nebo dotykovou obrazovku a nakreslete svůj podpis. Pokud to není možné, použijte namísto toho panely Text nebo Nahrát. ",
    "Draw your signature here" : "Svůj podpis nakreslete sem",
    ...
    "Decrease zoom level" : "Oddálit zobrazení",
    "Increase zoom level" : "Přiblížit zobrazení",
    "Fit image to frame" : "Přizpůsobit obrázek rámečku",
    "Zoom level" : "Zvětšení/zmenšení",
    "Use the mouse wheel or the zoom buttons to adjust." : "Pro přizpůsobení použijte kolečko myši nebo tlačítka přiblížení.",
    "Enter your Full Name or Initials to create Signature" : "Pokud chcete vytvořit podpis, zadejte své celé jméno nebo iniciály",
    "Files to sign" : "Soubory k podpisu",
    "No files to sign" : "Žádné soubory k podpisu",
    ...
    "A twig template to be used at footer of PDF. Will be rendered by mPDF." : "Twig šablona kterou použít jako zápatí PDF. Bude vykreslena pomocí mPDF.",
    "Preview" : "Náhled",
    "Width" : "Šířka",
    "Height" : "Výška",
    "Reset dimensions" : "Vrátit rozměry na výchozí",
    "Available template variables" : "Proměnné šablony k dispozici",
    "Click on a variable to copy it to clipboard" : "Proměnnou zkopírujete do schránky kliknutím na ní",
    ...
    "Undo" : "Zpět",
    "Redo" : "Zopakovat",
    "Document {docNumber} of {totalDocs} ({docName}), page {pageNumber} of {totalPages}. Press Enter or Space to place the signature here." : "Dokument {docNumber} z {totalDocs} ({docName}), strana {pageNumber} z {totalPages}. Podpis sem umístíte stisknutím Enter nebo mezerníku.",
    "Document {docNumber} of {totalDocs} ({docName}), page {pageNumber} of {totalPages}." : "Dokument {docNumber} z {totalDocs} ({docName}), strana {pageNumber} z {totalPages}.",
    "Page {pageNumber} of {totalPages}. Press Enter or Space to place the signature here." : "Strana {pageNumber} z {totalPages}. Podpis sem umístíte stisknutím Enter nebo mezerníku.",
    "Page {pageNumber} of {totalPages}." : "Stránka {pageNumber} z {totalPages}.",
    "{currentPage} of {totalPages}" : "{currentPage} z {totalPages}",
    "Duplicate" : "Zduplikovat",
    "Signature position for {name}" : "Pozice podpisu pro {name}",
    "Signature preview" : "Náhled podpisu",
    "Loading …" : "Načítání …",
    "Name" : "Název",
    "Update" : "Aktualizovat",
    "Failed to save or update signature request" : "Nepodařilo se uložit nebo aktualizovat požadavek na podepsání",
    "Please enter signer name." : "Zadejte jméno podepisujícího.",
    "This signer cannot be used because the identification method \"{method}\" has been disabled by the administrator." : "Tohoto podepisujícího nelze použít, protože metoda identifikace „{method}“ byla správcem zakázána.",
    "Signer name" : "Jméno podepisujícího",
    "Add custom message" : "Přidat uživatelsky určenou zprávu",
    "Custom message" : "Uživatelsky určená zpráva",
    "Add a personal message for this signer" : "Přidat osobní zprávu pro tohoto podepisujícího",
    "Select your files" : "Vyberte své soubory",
    "Select your file" : "Vyberte soubor",
    "Choose" : "Vybrat",
    "You can upload at most {max} files at once." : "Je možné nahrávat nejvýše {max} souborů naráz.",
    "Upload failed" : "Nahrání se nezdařilo",
    "Envelope name" : "Název obálky",
    "Enter a name for the envelope" : "Zadejte název pro obálku",
    "Upload from URL" : "Nahrát z URL",
    "Multiple files allowed" : "Umožněno vícero souborů",
    ...
    "Signature positions" : "Pozice podpisu",
    ...
    "Sign" : "Podepsat",
    "Progress: {signed} of {total} signed" : "Postup: {signed} z {total} podepsáno",
    "Signers" : "Podepisující",
    "Failed to load files" : "Nepodařilo se načíst soubory",
    "_Are you sure you want to remove %n file from the envelope?_::_Are you sure you want to remove %n files from the envelope?_" : ["Opravdu chcete odebrat %n soubor z obálky?","Opravdu chcete odebrat %n soubory z obálky?","Opravdu chcete odebrat %n souborů z obálky?","Opravdu chcete odebrat %n soubory z obálky?"],
    "Upload cancelled" : "Nahrávání zrušeno",
    "Saved" : "Uloženo",
    "Failed to update" : "Nepodařilo se zaktualizovat",
    "Are you sure you want to remove this file from the envelope?" : "Opravdu chcete odebrat tento soubor z obálky?",
    "Manage files ({count})" : "Spravovat soubory ({count})",
    "Enter envelope name" : "Zadejte název obálky",
    "No files in envelope" : "Žádné soubory v obálce",
    "Add files to get started" : "Začněte přidáním souborů",
    "_{count} selected_::_{count} selected_" : ["vybráno {count}","vybráno {count}","vybráno {count}","vybráno {count}"],
    "Select all" : "Vybrat vše",
    "Open file" : "Otevřít soubor",
    "Loading more files..." : "Načítání dalších souborů…",
    "Add file" : "Přidat soubor",
    "Close" : "Zavřít",
    "Edit signer" : "Upravit podepisujícího",
    "Add new signer" : "Přidat nového podepisujícího",
    "Failed to save signature request" : "Žádost o podepsání se nepodařilo uložit",
    "Failed to load signer details" : "Nepodařilo se načíst podrobnosti o podepisujícím",
    "Document not found" : "Dokument nenalezen",
    "Signer request not found" : "Požadavek podepisujícího nenalezen",
    "Failed to send reminder" : "Nepodařilo se odeslat připomínku",
    "Signature requested" : "Vyžádán podpis",
    "Failed to request signature" : "Nepodařilo se požádat o podpis",
    "Failed to request signatures" : "Nepodařilo se požádat o podpisy",
    "Document URL not found" : "URL dokumentu nenalezena",
    "Error monitoring signing progress" : "Chyba při monitorování procesu podepisování",
    "The original file was deleted. You can no longer add signers or open it." : "Původní soubor byl smazán. Není už možné přidávat podepisující nebo ho otevřít.",
    "Some signers use identification methods that have been disabled. Please remove or update them before requesting signatures." : "Někteří podepisující používají metody identifikace, které byly vypnuty. Než budete žádat o podpisy, tyto metody odeberte nebo zaktualizujte.",
    "Loading signer details..." : "Načítání podrobností o podepisujícím…",
    "Add signer" : "Přidat podepisujícího",
    "Sign in order" : "Pořadí podepisování",
    "View signing order" : "Zobrazit pořadí podepisování",
    "Signing order" : "Pořadí podepisování",
    "Customize message" : "Přizpůsobit zprávu",
    "Request signature" : "Požádat o podpis",
    "Send reminder" : "Odeslat připomínku",
    "Setup signature positions" : "Nastavit pozice podpisů",
    "Request signatures" : "Vyžádat podpisy",
    "Sign document" : "Podepsat dokument",
    "Validation info" : "Informace o ověřování",
    "Confirm" : "Potvrdit",
    "Send signature request?" : "Odeslat požadevek na podepsání?",
    "Signing order diagram" : "Diagram pořadí podepisování",
    ...
    "Signer {name} (already signed)" : "Podepisující {name} (už podepsán)",
    "Edit signer {name}" : "Upravit podepisujícího {name}",
    "Identification method: {method}" : "Metoda identifikace: {method}",
    "Signer status: {status}" : "Stav podepisujícího: {status}",
    ...
    "Contact" : "Kontakt",
    "Order" : "Pořadí",
    "Signed at" : "Podepsáno v",
    "COMPLETED" : "DOKONČENO",
    "Open sidebar" : "Otevřít postranní panel",
    "a few seconds left" : "zbývá několik sekund",
    "{seconds} seconds left" : "zbývá {seconds} sekund",
    "{minutes} minutes left" : "zbývá {minutes} minut",
    "Cancel upload" : "Zrušit nahrávání",
    "Collapse certificate chain" : "Sbalit řetěz certifikátu",
    "Expand certificate chain" : "Rozbalit řetěz certifikátu",
    "Signer certificate" : "Certifikát podepisujícího",
    "Certificate {index}" : "Certifikát {index}",
    "Signer:" : "Podepisující:",
    "Issuer:" : "Vydavatel:",
    "Certificate chain" : "Řetězec certifikátu",
    "Certificate chain details" : "Podrobnosti o řetězu certifikátu",
    "Issued by:" : "Vydal:",
    ...
    "Unknown" : "Neznámé",
    "_{progress} of {total} document signed_::_{progress} of {total} documents signed_" : ["{progress} z {total} dokumentu podepsán","{progress} z {total} dokumentů podepsány","{progress} z {total} dokumentů podepsáno","{progress} z {total} dokumentů podepsány"],
    "Envelope information" : "Informace o obálce",
    ...
    "Last signature date:" : "Datum posledního podpisu:",
    "Documents in this envelope" : "Dokumenty v této obálce",
    "Click on a document to view its details and signatures" : "Podrobnosti a podpisy dokumentu si zobrazíte kliknutím na něj",
    "View PDF" : "Zobrazit PDF",
    "Hide details" : "Skrýt podrobnosti",
    "Show details" : "Zobrazit podrobnosti",
    "Signers summary" : "Souhrn podepisujících",
    "Overall progress of each signer across all documents" : "Celkový postup každého z podepisujících napříč všemi dokumenty",
    "Requested on:" : "Kdy požádáno:",
    "Date signed:" : "Datum podpisu:",
    "Not signed yet" : "Zatím nepodepsáno",
    ...
    "CRL: No URLs found" : "CRL: nenalezeny žádné URL",
    "CRL: URLs inaccessible" : "CRL: URL nejsou přístupné",
    "CRL: Validation failed" : "CRL: ověření správnosti se nezdařilo",
    "CRL: Validation error" : "CRL: chyba ověření správnosti",
    "Document integrity verified" : "Neporušenost dokumentu ověřena",
    "Document integrity check failed" : "Kontrola neporušenosti dokumentu se nezdařila",
    "Trust Chain: Trusted ({trustedBy})" : "Řetěz důvěry: důvěryhodné ({trustedBy})",
    "Trust Chain: Not Trusted" : "Řetěz důvěry: nedůvěryhodný",
    "CRL: Certificate revoked before signing" : "CRL: platnost certififikátu odvolána před podepsáním",
    "CRL: Valid at signing time (revoked on {date})" : "CRL: platné v okamžiku podpisu (platnost odvolána v {date})",
    "CRL: Valid at signing time" : "CRL: platné v okamžiku podpisu",
    "Collapse details of {signerName}" : "Sbalit podrobnosti o {signerName}",
    "Expand details of {signerName}" : "Rozbalit podrobnosti o {signerName}",
    "Expiration:" : "Konec platnosti:",
    "No expiration date" : "Žádné datum skončení platnosti",
    "No date" : "Žádné datum",
    "Validation status" : "Stav ověřování",
    "Collapse validation status" : "Sbalit stav ověřování",
    "Expand validation status" : "Rozbali stav ověřování",
    "Valid at signing time" : "Platné v okamžiku podpisu",
    "NOT valid at signing time" : "NEplatné v okamžiku podpisu",
    "Document certification" : "Certifikace dokumentu",
    "Collapse document certification" : "Sbalit certifikaci dokumentu",
    "Expand document certification" : "Rozbalit certifikaci dokumentu",
    "Certification level:" : "Stupeň certifikace:",
    ...
    "Signed on" : "Kdy podepsáno",
    "Awaiting signature" : "Čeká na podpis",
    "Signing finished with errors" : "Podepisování dokončeno bez chyb",
    "Signing document..." : "Podepisování dokumentu…",
    "Some files could not be signed. Please review the errors below." : "Některé soubory nebylo možné podepsat. Podívejte se na níže uvedené chyby.",
    "Your document is being signed. This may take a few moments." : "Váš dokument je podepisován. Může to pár okamžiků trvat.",
    "Signing failed. Please try again." : "Podepisování se nezdařilo. Zkuste to prosím znovu.",
    "Document ready to sign" : "Dokument připraven k podpisu",
    "Failed to check signing progress" : "Nepodařilo se zkontrolovat stav podepisování",
    "Error" : "Error",
    "In progress" : "Probíhá",
    "File" : "Soubor",
    "Details" : "Podrobnosti",
    ...
    "Your identification documents are waiting for approval." : "Vaše identifikační doklady čekají na schválení.",
    ...
    "Delete {type}" : "Smazat {type}",
    "Edit {type}" : "Upravit {type}",
    "Current {type}" : "Stávající {type}",
    ...
    "Key Compromise" : "Kompromitace klíče",
    "CA Compromise" : "Kompromitace cert. autority",
    "Affiliation Changed" : "Příslušnost změněna",
    "Superseded" : "Nahrazeno",
    "Cessation of Operation" : "Ukončení fungování",
    "Certificate Hold" : "Zadržení certifikátu",
    "Remove from CRL" : "Odebrat z CRL seznamu",
    "Privilege Withdrawn" : "Zrušení oprávnění",
    "AA Compromise" : "Kompromitace AA",
    "Failed to load CRL entries" : "Nepodařilo se načíst položky CRL seznamu",
    "Root Certificate (CA)" : "Kořenový certifikát (CA)",
    "Intermediate Certificate (CA)" : "Mezilehlá certifikační autorita (CA)",
    "User Certificate" : "Uživatelský certifikát",
    "Certificate revoked successfully" : "Platnost certifikátu úspěšně odvolána",
    "Failed to revoke certificate" : "Nepodařilo se odvolat platnost certifikátu",
    "An error occurred while revoking the certificate" : "Došlo k chybě při odvolávání platnosti tohoto certifikátu",
    "Filters ({count})" : "Filtry ({count})",
    "Filters" : "Filtry",
    "Serial Number" : "Sériové číslo",
    "Owner" : "Vlastník",
    "Clear filters" : "Vyčistit filtry",
    "No CRL entries found" : "Nenalezeny žádné položky CRL seznamu",
    "There are no certificate revocation list entries to display." : "Nejsou zde žádné seznamy odvolání platnosti certifikátů k zobrazení.",
    "Type" : "Typ",
    "Engine" : "Engine",
    "Issued At" : "Vydáno v",
    "Valid To" : "Platné do",
    "Revoked At" : "Platnost odvolána v",
    "Reason" : "Důvod",
    "Comment" : "Komentář",
    "Actions" : "Akce",
    "Root CA" : "Kořenová cert. autorita",
    "Intermediate CA" : "Mezilehlá certifikační autorita",
    "User" : "Uživatel",
    "Revoke" : "Odvolat",
    "No more entries to load" : "Žádné další položky k načtení",
    "Warning: Certificate Authority" : "Varování: certifikační autorita",
    "You are about to revoke a {type} CERTIFICATE AUTHORITY. This is a critical operation that may invalidate certificates issued by this CA." : "Chystáte se odvolat platnost {type} CERTIFIKAČNÍ AUTORITU. Toto je kritická operace, která může vést ke zneplatnění certifkátů, vydaných touto cert. autoritou.",
    "Owner:" : "Vlastník:",
    "Type:" : "Typ:",
    "Are you absolutely sure you want to proceed?" : "Opravdu jste si jistí, že chcete pokračovat?",
    "Yes, revoke CA" : "Ano, zrušit platnost certifikační autority",
    "Revoke Certificate" : "Odvolat platnost certifikátu",
    "This action cannot be undone. The certificate will be permanently revoked." : "Tuto akci nelze vzít zpět. Platnost certifikátu bude nevratně odvolána.",
    "WARNING: This is a CERTIFICATE AUTHORITY! Revoking it will affect the certificate chain and may invalidate certificates issued by this CA." : "VAROVÁNÍ: Toto je CERTIFIKAČNÍ AUTORITA! Odvoláním její platnosti postihne řetěz certifikátů a může vést ke zneplatnění certifkátů, vydaných touto cert. autoritou.",
    "Revocation Reason" : "Důvod odvolání",
    "Reason Description (optional)" : "Popis důvodu (volitelné)",
    ...
    "File list is reloading" : "Seznam souborů je znovu načítán",
    ...
    "(selected)" : "(vybráno)",
    "List of files. Column headers with buttons are sortable." : "Seznam souborů. Sloupce, které mají v záhlaví tlačítka, je možné řadit.",
    ...
    "Active Signings" : "Aktivní podepisování",
    "Monitor documents currently being signed" : "Monitorovat právě podepisované dokumenty",
    "Auto-refresh" : "Automaticky znovu načítat",
    "Refresh" : "Znovu načíst",
    "No documents are currently being signed" : "V tuto chvíli nejsou podepisovány žádné dokumenty",
    "Last Updated" : "Naposledy aktualizováno",
    "Last updated: {time}" : "Naposledy aktualizováno: {time}",
    ...
    "Collect signers'metadata when signing a document" : "Při podepisování dokumentu shromáždit metadata podepisujícího",
    "Confetti animation" : "Animace konfety",
    "Control whether a confetti animation is shown after a document is signed." : "Ovládá zda je po podepsání dokumentu zobrazena animace konfet.",
    "Show confetti animation after signing" : "Po podepsání zobrazit animaci konfet",
    "Configuration check" : "Kontrola nastavení",
    "Status of setup" : "Stav nastavení",
    "Message" : "Zpráva",
    "Resource" : "Zdroj",
    "Tip" : "Tip",
    "Certificate Revocation (CRL)" : "Odvolání platnosti certifikátu (CRL)",
    "Controls external CRL validation when signing with personal certificates." : "Ovládá externí CRL ověřování při podepisování osobními certifikáty.",
    "Validate external CRL Distribution Points" : "Ověřit externí CRL distribuční body",
    "The PHP LDAP extension is not installed. Users with certificates that use LDAP-based CRL Distribution Points will not be able to sign documents." : "PHP rozšíření pro LDAP není nainstalované. Uživatelé s certifikáty které používají CRL distribuční body založené na LDAP nebudou moci podepisovat dokumenty.",
    "External CRL validation is disabled. Revocation of certificates from external authorities will not be checked. Certificates issued by LibreSign are not affected." : "Externí ověřování CRL je vypnuté. Odvolání certifikátů od externích autorit nebude kontrolováno. Certifikátů vydaných LibreSign se toto netýká.",
    ...
    "PDF certification (DocMDP)" : "PDF certifikace (DocMDP)",
    "Could not load configuration." : "Nebylo možné načíst nastavení.",
    "Could not save configuration." : "Nebylo možné uložit nastavení.",
    "DocMDP defines what types of changes are allowed in a PDF after it is signed, ensuring viewers can detect unauthorized modifications." : "DocMDP definuje jaké typy změn jsou v PDF po podepsání dovoleny, což zajišťuje, že při následném zobrazení je možné zjistit neautorizované změny.",
    "Enable DocMDP" : "Zapnout DocMDP",
    "Default certification level for new signatures:" : "Výchozí stupeň certifikace pro nové podpisy:",
    ...
    "Envelopes" : "Obálky",
    "Enable or disable the envelopes feature. When enabled, users can group several files into an envelope and manage them as a single signing process." : "Zapnout nebo vypnout funkci obálek. Pokud zapnuto, uživatelé mohou seskupit vícero souborů do obálky a spravovat je jako jeden proces podepisování.",
    "Enable envelopes (group multiple files into one signing flow)" : "Zapnout obálky (seskupovat vícero souborů do jednoho toku podepisování)",
    ...
    "Native" : "Nativní",
    "Signature engine" : "Engine podepisování",
    "Select the signature engine to sign the documents" : "Pro podepsání dokumentů vyberte podepisovací engine",
    "Simultaneous (Parallel)" : "Souběžně (paralelně)",
    "All signers receive the document at the same time and can sign in any order." : "Všichni podepisující obdrží dokument ve stejný okamžik a mohou ho podepsat v libovolném pořadí.",
    "Sequential" : "Sekvenční",
    "Signers are organized by signing order number. Only those with the lowest pending order number can sign." : "Podepisující jsou uspořádávání podle čísla pořadí podepisování. Podepsat mohou pouze ti s nejnižším číslem čekání v pořadí.",
    "Error saving configuration." : "Chyba při ukládání nastavení",
    "Set default signing order" : "Nastavit výchozí pořadí podepisování",
    ...
    "Configure the content displayed with the signature. The text template uses Twig syntax: https://twig.symfony.com/" : "Nastavte obsah, zobrazovaný společně s podpisem. Šablona textu používá syntaxi Twig: https://twig.symfony.com/",
    ...
    "Error saving parallel workers configuration." : "Chyba při ukládání nastavení souběžně zpracovávajících vláken.",
    "Signing mode" : "Režim podepisování",
    "Sign documents asynchronously in the background" : "Podepisovat dokumenty asynchronně na pozadí",
    "Use external worker service" : "Použít externí službu zpracování",
    "You must manage and keep the external worker running manually." : "Externí zpracovávající vlákna je třeba spravovat a udržovat v chodu ručně.",
    "Nextcloud manages the background worker automatically." : "Nextcloud spravuje proces zpracovávající na pozadí automaticky.",
    "Configure how many background workers should process signing jobs in parallel. More workers increase throughput but consume more resources. Valid range: 1-32." : "Nastavte kolik procesů zpracovávajících na pozadí by mělo zpracovávat úlohy podepisování naráz. Více procesů zvýší propustnost ale spotřebuje více systémových prostředků. Platný rozsah: 1-32.",
    "Number of parallel workers" : "Počet souběžně zpracovávajících vláken",
    "Default: {workers} workers" : "Výchozí: {workers} zpracovávajících vláken",
    ...
    "Customize footer template" : "Přizpůsobit šablonu zápatí",
    "Failed to load envelope files" : "Nepodařilo se načíst soubory obálky",
    "PDF document to sign" : "PDF dokument k podpisu",
    "Email verification" : "Ověřování e-mailem",
    "Identity verification" : "Ověření identitiy",
    "Code validation" : "Ověření kódu",
    "Signature confirmation" : "Potvrzení podpisu",
    "Step 1 of 3 - Email verification" : "Krok 1 ze 3 – ověření e-mailu",
    "Step 1 of 3 - Identity verification" : "Krok 1 ze 3 – ověření identity",
    "Step 2 of 3 - Code validation" : "Krok 2 ze 3 – ověření kódu",
    ...
    "Enter your contact information" : "Zadejte své kontaktní údaje",
    "Enter your code" : "Zadejte svůj kód",
    "Your identity has been verified." : "Vaše identita byla ověřena.",
    "You can now sign the document." : "Nyní můžete dokument podepsat.",
    "Send verification code" : "Zaslat ověřovací kód",
    "Request new code" : "Vyžádat si nový kód",
    "Validate code" : "Ověřit kód",
    "You do not have any signature defined." : "Nemáte definovaný žádný podpis.",
    "Define your signature." : "Definujte si svůj podpis.",
    "You need to upload your certificate to sign the document." : "Pokud chcete podepsat dokument, je třeba nahrát váš certifikát.",
    ...
    "Confirm that you want to sign this document." : "Potvrďte že chcete tento dokument podepsat.",
    "Enter your signature password to sign the document." : "Pro podepsání dokumentu zadejte heslo ke svému podpisu.",
    "Signature password" : "Heslo podpisu",
    "Forgot password?" : "Zapomněli jste heslo?",
    "Unknown validity" : "Neznámá platnost",
    "Expiring soon" : "Platnost brzy skončí",
    "Currently valid" : "V tuto chvíli platné",
    "Not revoked" : "Platnost neodvolána",
    "Certificate revoked" : "Platnost certifikátu odvolána",
    "No CRL information" : "Žádná CRL informace",
    "No CRL URLs found" : "Nenalezeny žádné URL adresy CRL seznamů",
    "CRL URLs inaccessible" : "URL adresy CRL nepřístupné",
    "CRL validation failed" : "CRL ověřování se nezdařilo",
    "CRL validation error" : "Chyba CRL ověřování",
    "Failed to validate document" : "Nepodařilo se ověřit dokument",
    "Partial" : "Poměrové",
    "Complete" : "Kompletní",
    "This document is valid" : "Tento dokument je platný",
    "Signature: Unknown" : "Podpis: neznámý",
    "Signature: {validationStatus}" : "Podpis: {validationStatus}",
    "Trust Chain: Unknown" : "Řetěz důvěry: neznámý",
    "Trust Chain: Trusted (LibreSign CA)" : "Řetěz důvěry: důvěryhodné (LibreSign CA)",
    "Trust Chain: Trusted" : "Řetěz důvěry: důvěryhodný",
    "Trust chain: {validationStatus}" : "Řetěz důvěry: {validationStatus}",
    ...
    "Failed to add files to envelope" : "Nepodařilo se přidat soubory do obálky",
    "File removed from envelope" : "Soubor odebrán z obálky",
    "Files removed from envelope" : "Soubory odebrány z obálky",
    "Failed to remove file(s) from envelope" : "Nepodařilo se odebrat soubor(y) z obálky",
    ...
    "Signed by {name}" : "Podepsal/a {name}",
