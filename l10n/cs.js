OC.L10N.register(
    ...
    "File type: %s. Specify a URL, base64 string, path or a fileID." : "Typ souboru: %s. Zadejte URL, řetězec base64 nebo identif. souboru.",
    ...
    "Do not use mixed identify data." : "Nepoužít smíšené identifikační údaje.",
    ...
    "Signatures" : "Podpisy",
    "Search signer by account" : "Hledat podepisujícího podle účtu",
    "Name" : "Název",
    "No recommendations. Start typing." : "Žádná doporučení. Pište.",
    "Account is mandatory" : "Je třeba zadat účet",
    "Searching …" : "Hledání…",
    "No elements found." : "Nenalezeny žádné prvky.",
    "E-mail of signer" : "E-mail podepisujícího",
    "Please enter an email address." : "Zadejte e-mailovou adresu",
    "Update" : "Aktualizovat",
    "Description" : "Popis",
    "Add" : "Přidat",
    "Users" : "Uživatelé",
    ...
    "Allow account creation for new users" : "Umožnit účtu vytvářet nové uživatele",
    "Allows sending registration email when the user does not have an account." : "Umožňuje poslat e-mail pro případ, že uživatel zde nemá účet.",
    "Default signature method" : "Výchozí metoda podepisování",
