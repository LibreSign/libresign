OC.L10N.register(
    ...
    "Date and time when the signer send the request to sign (in their local time zone)." : "Datum a čas, kdy podepisující odeslal požadavek na podepsání (v jeho místním časovém pásmu).",
    "Time zone of signer when send the request to sign (in their local time zone)." : "Časové pásmo, ve kterém se podepisující nacházel v okamžiku odeslání požadavku na podepsání (v jeho místním časovém pásmu).",
    ...
    "Certificate valid from:" : "Certifikát platný od:",
    "Certificate valid to:" : "Certifikát platný do:",
