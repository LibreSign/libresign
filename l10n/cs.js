OC.L10N.register(
    ...
    "The signature request has been cancelled." : "Požadavek na podepsání byl zrušen.",
    ...
    "Remove duplicated users, email need to be unique" : "Odeberte duplicitní uživatele, e-mail se nemůže opakovat",
    "Document already signed" : "Dokument už je podepsán",
    "No signature was requested to %s" : "Pro %s nebyl vyžádán podpis",
    "User need to be email: user %s" : "Je třeba, aby uživatel by e-mail: uživatel %s",
    ...
    "Sorry but the page you are looking for does not exist, have been removed, name changed or is temporarily unavailable." : "Je nám líto, ale stránka kterou hledáte neexistuje, byla odebrána, přejmenována nebo je dočasně nedostupná.",
    ...
    "Signed document available on {place}" : "Podepsané dokumenty jsou k dispozici na {place}",
