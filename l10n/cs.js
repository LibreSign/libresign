OC.L10N.register(
    ...
    "Notification sent with success." : "Oznámení úspěšně posláno",
    ...
    "You are not the signer request for this file" : "Nejste ten, kdo má tento dokument podepsat",
    ...
    "%s already signed this file" : "%s už podepsal tento soubor",
    ...
    "Resubmit request" : "Znovu odeslat požadavek",
    ...
    "You need to create an account with the same email you received the invitation" : "Musíte vytvořit účet se stejným emailem na který jste obdrželi pozvánku",
    "The email entered is not the same as the email in the invitation" : "Zadaný email není stejný jako email v pozvánce",
