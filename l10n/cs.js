OC.L10N.register(
    ...
    "Collect signers metadata when signing a document" : "Shromažďování metadat podepisujících osob při podepisování dokumentu",
    "Collect signers metadata" : "Shromáždit metadata o podepisujících",
    "Enabling this feature, everytime a document is signed, LibreSign will store the IP address and user agent of the signer." : "Pokud tuto funkci povolíte, bude LibreSign při každém podepisování dokumentu ukládat IP adresu a agenta uživatele, který dokument podepsal.",
    "Message" : "Zpráva",
    "Resource" : "Zdroj",
    "Advice" : "Rada",
