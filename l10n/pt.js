OC.L10N.register(
    ...
    "Internal error. Contact admins." : "Erro interno. Contacte o administrador.",
    ...
    "User already exists. Please loggin." : "Usuário já existe. Por favor, autentique-se.",
    ...
    "Dont is your file" : "Arquivo não é seu.",
    ...
    "The signature request has been cancelled." : "A solicitação de assinatura foi cancelada.",
    ...
    "Invalid file UUID" : "UUID de arquivo inválido",
    "Empty users collection" : "Listagem de usuários vazia",
    "User collection need to be an array" : "Listagem de usuários precisa ser um array",
    "Remove duplicated users, email need to be unique" : "Remova os usuários duplicados, email precisa ser único",
    "Document already signed" : "Documento já assinado",
    "No signature was requested to %s" : "Não foram solicitadas assinaturas para %s",
    "User collection need to be an array: user %s" : "Listagem de usuário precisa ser um array: usuário %s",
    "User collection need to be an array with values: user %s" : "Listagem de usuários precisa ser um array com valores: usuário %s",
    "User need to be email: user %s" : "Usuário precisa de um email: usuário %s",
    "Invalid email: user %s" : "Email inválido: usuário %s",
    "Another file like this already exists" : "Outro arquivo parecido com este já existe",
    ...
    "Sorry but the page you are looking for does not exist, have been removed, name changed or is temporarily unavailable." : "Desculpe mas esta página que você está vendo não existe, foi removida, mudou de nome ou está temporariamente indisponível.",
    ...
    "Select subscription location." : "Selecione um local para a assinatura.",
    "Select Subscription." : "Selecionar uma assinatura.",
    "Signed document available at {date}" : "Documento assinado disponível em {date}",
