OC.L10N.register(
    ...
    "Invalid data to generate certificate" : "Недійсні дані для генерації сертифіката",
    ...
    "File type: %s. Invalid fileID." : "Тип файлу: %s. Недійсний ідентифікатор файлу.",
    ...
    "Invalid file provided. Need to be a .pfx file." : "Надано недійсний файл. Має бути файл у форматі .pfx.",
    ...
    "LibreSign, digital signature app for Nextcloud." : "LibreSign - застосунок для цифрового підпису у Nextcloud.",
    ...
    "Customize default user folder" : "Налаштувати типовий каталог користувача",
