OC.L10N.register(
    ...
    "Could not download binaries." : "Не вдалося завантажити двійкові файли.",
    ...
    "Sign" : "Знак",
    "Confirm" : "Підтвердити",
    "Request signatures?" : "Вимагати підписів?",
    "Edit visible signatures" : "Редагувати видимі підписи",
    ...
    "signed at {date}" : "підписаний за адресою {date}",
    "pending" : "на розгляді",
    ...
    "Your profile documents" : "Документи вашого профілю",
    "Type" : "Тип",
    "Status" : "Статус",
    "Actions" : "Дії",
    ...
    "Certificate valid from:" : "Сертифікат дійсний від:",
    "Certificate valid to:" : "Сертифікат дійсний до:",
    ...
    "Download binaries" : "Завантажити двійкові файли",
    ...
    "Sign with your cellphone number." : "Підпишіться своїм номером мобільного телефону.",
    "Save your number." : "Збережи свій номер.",
    ...
    "Signature validation:" : "Перевірка підпису:",
    "Certificate validation:" : "Валідація сертифікату:",
