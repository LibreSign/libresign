OC.L10N.register(
    ...
    {
    "Success" : "Úspešné",
    "Invalid user or password" : "Neplatný uživateľ alebo heslo",
    "_Element created with success_::_Elements created with success_" : ["Prvok bol úspešne vytvorený","Prvkov bolo úspešne vytvorených","Prvkov bolo úspešne vytvorených","Prvky boli úspešne vytvorené"],
    ...
    "You must not sign this file." : "Tento súbor nesmiete podpísať.",
    ...
    "User already exists. Please login." : "Uživateľ už existuje. Prosím prihláste sa.",
    ...
    "Empty users list" : "Prázdny zoznam uživateľov",
    ...
    "Authorize signing using %s token is disabled because Nextcloud Two-Factor Gateway is not enabled." : "Autorizácia podpisovania pomocou %s tokenu je zakázaná, pretože nie je povolená dvojfaktorová brána Nextcloud.",
    ...
    "Details" : "Podrobnosti",
    "Are you sure you want to exclude user {email} from the request?" : "Ste si istý že chcete vylúčiť užívateľa {email} zo žiadosti?",
    "Account not exist" : "Účet neexistuje",
    "This iframe is not supported in your browser." : "Váš prehliadač nepodporuje tento iframe.",
    "Insert Signature and/or Initials" : "Vložte podpis a/alebo iniciály",
    "Return" : "Späť",
    "Email" : "Email",
    "Description" : "Popis",
    "Add" : "Pridať",
    ...
    "Account" : "Účet",
    "Enter your password to sign this document" : "Zadajte heslo pre podpísanie tohoto dokumentu",
    "You need to create a password to sign this document. Click \"Create password to sign document\" and create a password." : "Na podpísanie tohto dokumentu musíte vytvoriť heslo. Kliknite na „Vytvoriť heslo na podpísanie dokumentu“ a vytvorte heslo.",
    "Forgot your password?" : "Zabudli ste heslo?",
    "Create password to sign document" : "Vytvoriť heslo pre podpisovanie dokumentu",
    "Password & Security" : "Heslo a Bezpečnosť",
    "Create password key" : "Vytvoriť kľúč hesla",
    ...
    "Next" : "Ďalšie",
    "Set a password to sign the document" : "Nastaviť heslo pre podpis dokumentu",
    "Password for sign document." : "Heslo pre podpis dokumentu.",
    "Do you want to create your signature and initials now?" : "Chcete teraz vytvoriť svoj podpis a iniciály?",
    "Yes" : "Áno",
    "No" : "Nie",
    "Congratulations, you have created your account. Please wait, we will redirect you to the requested signature file." : "Gratulujeme, vytvorili ste si účet. Počkajte prosím, presmerujeme vás na váš podpisový súbor.",
    ...
    "Generate Subscription." : "Vygenerovať Podpis.",
    "Subscription generated and available at {path}!" : "Podpis vygenerovaný a prístupný v {path}!",
    "Could not create signature." : "Nemôžem vytvoriť podpis.",
    "Status" : "Stav",
    "Validate Document" : "Overiť Dokument",
    "Pending" : "Čakajúce",
    "Signed" : "Podpísané",
    "Do you want to configure visible elements in this document?" : "Chcete v tomto dokumente nakonfigurovať viditeľné prvky?",
    ...
    "Enter the emails that will receive the request" : "Zadajte e -maily, na ktoré bude žiadosť odoslaná",
    "Signatures for this document have already been requested" : "Podpisy pre tento dokument už boli vyžiadané",
    ...
    "Request signatures?" : "Vyžiadať podpisy?",
    "Element created" : "Prvok vytvorený",
    "Select each signer to define theirs signature positions" : "Vyberte každého podpisovateľa a definujte jeho podpisové pozície",
    "Remove" : "Odobrať",
    "Previous" : "Predchádzajúce",
    "Create your signature" : "Vytvorte si svoj podpis",
    "Create your password for signing PDF" : "Vytvorte si heslo pre podpisovanie PDF",
    ...
    "This feature already exists." : "Táto funkcia už existuje.",
    "Feature {feature} enabled." : "Funkcia {feature} je zapnutá.",
    "This feature does not exist." : "Táto funkcia neexistuje.",
    "This feature is already enabled." : "Táto funkcia už bola povolená.",
    "Feature enabled." : "Funkcia povolená.",
    "This feature is not enabled." : "Táto funkcia nie je povolená.",
    "Feature disabled." : "Funkcia vypnutá.",
