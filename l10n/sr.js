OC.L10N.register(
    ...
    "Date and time when the signer send the request to sign (in their local time zone)." : "Датум и време када је потписник послао захтев за потписивање (у његовој локалној временској зони).",
    "Time zone of signer when send the request to sign (in their local time zone)." : "Временска зона из које је потписник послао захтев за потписивање (у његовој локалној временској зони).",
