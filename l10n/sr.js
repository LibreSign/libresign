OC.L10N.register(
    ...
    "Signature created!::_Elements created with success_" : ["Елемент је успешно креиран","Елемента је успешно креирано","Елемената је успешно креирано"],
    ...
    "File type: %s. Inform URL or base64 or fileID." : "Тип фајла: %s. Inform URL или base64 или fileID.",
    "Allowed to sign document" : "Смеју да потпишу документ",
    "Select authorized groups." : "Изаберите одобрене групе.",
    "Tip" : "Савет",
    ...
    "Country (C)" : "Земља (C)",
    "Organization (O)" : "Организација (O)",
    "Organization Unit (OU)" : "Организациона јединица (OU)",
    "To validate signature of the documents" : "Да потврдите потпис докумената",
