OC.L10N.register(
    ...
    "Empty identify data." : "Празни идентификациони подаци.",
    "Do not use mixed identify data." : "Не користите мешане идентификационе податке.",
    ...
    "Signatures" : "Потписи",
    "Search signer by account" : "Претрага порписника према налогу",
    "Name" : "Име",
    "No recommendations. Start typing." : "Нема препорука. Започните куцање.",
    "Account is mandatory" : "Налог је обавезан",
    "Searching …" : "Тражим…",
    "No elements found." : "Нема нађених елемената.",
    "E-mail of signer" : "И-мејл потписивача",
    "Please enter an email address." : "Молимо вас да унесете и-мејл адресу.",
    "Update" : "Ажурирај",
    "Description" : "Опис",
    "Add" : "Додај",
    "Users" : "Корисници",
    ...
    "Allow account creation for new users" : "Дозволи креирање налога за нове кориснике",
    "Allows sending registration email when the user does not have an account." : "Дозвољава слање и-мејла за регистрацију када корисник нема налог.",
    "Default signature method" : "Подразумевана метода потписивања",
    "Identify factors" : "Фактори идентификације",
    ...
    "Collect signers metadata when sign a document" : "Сакупи метаподатке потписника када потписују овај документ",
    "Collect signers metadata" : "Прикупи метаподатке потписника",
    "Enabling this feature, every when sign a document, LibreSign will store the IP, and user agent of signer." : "Када се ова могућност укључи, сваки пут када се документ потписује, LibreSign ће сачувати IP адресу и кориснички агент потписника.",
    "Advice" : "Савет",
    "Binaries required to work. Could be near by 340Mb to download, wait a moment." : "Неопходни су бинарни фајлови за рад. Величина преузимања може бити скоро 340Mb, причекајте мало.",
