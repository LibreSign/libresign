OC.L10N.register(
    ...
    "**This is a libre digital PDF signature app for Nextcloud**\n\n* ✍️ **Sign PDF** documents using digital certificates\n* 🔄 **Hybrid signatures**: You can choose between personal or system-generated digital certificates\n* 👥 **Multiple signers**: Request signature on a document for as many people as you need\n* 📸 **QR Code**: Document validation by QR Code\n* 🔒 **Privacy**: Fully self-hosted document signer\n* 📲 **Connect to your software**: Easily integrate [LibreSign](https://libresign.coop) into your service with our full-fledged\n* 🙋 **Get involved**! We have lots of stuff planned. More informations at [LibreSign](https://github.com/libresign/libresign) repository.\n\n🌍 Help us translate this application on [Transifex](https://app.transifex.com/nextcloud/nextcloud/libresign/)\n\nIf you enjoy this app and want to help maintain its development or want enterprise support, please contact us:\n\n[https://libresign.coop](https://libresign.coop)\n\n## Donation\n\nDeveloped with ❤️ by [LibreCode](https://librecode.coop). Help us transform people and businesses through cooperativism.\n\n* [Donate with GitHub Sponsor: ![Donate using GitHub Sponsor](https://img.shields.io/static/v1?label=Sponsor&message=%E2%9D%A4&logo=GitHub&color=%23fe8e86)](https://github.com/sponsors/libresign)" : "**Dette er en fri digital PDF-signaturapp for Nextcloud**\n\n* ✍️ **Signer PDF**-dokumenter ved hjelp av digitale sertifikater\n* 🔄 **Hybride signaturer**: Du kan velge mellom personlige eller systemgenererte digitale sertifikater\n* 👥 **Flere underskrivere**: Be om signatur på et dokument for så mange personer du trenger\n* 📸 **QR-kode**: Dokumentvalidering med QR-kode\n* 🔒 **Personvern**: Fullstendig selvdriftet dokumentunderskriver\n* 📲 **Koble til programvaren**: Integrer enkelt [LibreSign] (https://libresign.coop) i tjenesten din med vår fullverdige\n* 🙋 **Engasjer deg**! Vi har mange ting planlagt. Mer informasjon på [LibreSign](https://github.com/libresign/libresign) oppbevaringssted.\n\n🌍 Hjelp oss med å oversette denne applikasjonen på [Transifex](https://app.transifex.com/nextcloud/nextcloud/libresign/)\n\nHvis du liker denne appen og ønsker å bidra til å opprettholde utviklingen eller ønsker bedriftsstøtte, kan du kontakte oss:\n\n[https://libresign.coop](https://libresign.coop)\n\n## Donering\n\nUtviklet med ❤️ av [LibreCode](https://librecode.coop). Hjelp oss med å forvandle mennesker og bedrifter gjennom kooperativisme.\n\n* [Doner med GitHub Sponsor: ![Doner ved hjelp av GitHub Sponsor](https://img.shields.io/static/v1?label=Sponsor&message=%E2%9D%A4&logo=GitHub&color=%23fe8e86)](https://github.com/sponsors/libresign)",
