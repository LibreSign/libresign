OC.L10N.register(
    ...
    "Edit visible signatures" : "Επεξεργασία ορατών υπογραφών",
    ...
    "signed at {date}" : "υπογράφηκε στις {date}",
    "pending" : "εκκρεμεί",
    ...
    "Your profile documents" : "Τα έγγραφα προφίλ σας",
    "Type" : "Τύπος",
    "Status" : "Κατάσταση",
    "Actions" : "Ενέργειες",
    ...
    "Certificate valid from:" : "Πιστοποιητικό έγκυρο από:",
    "Certificate valid to:" : "Πιστοποιητικό έγκυρο έως:",
    ...
    "Sign with your cellphone number." : "Υπογράψτε με τον αριθμό του κινητού σας τηλεφώνου.",
    "Save your number." : "Αποθηκεύστε τον αριθμό σας.",
    ...
    "Signature validation:" : "Επικύρωση υπογραφής:",
    "Certificate validation:" : "Επικύρωση πιστοποιητικού:",
