OC.L10N.register(
    ...
    "Do not use mixed identify data." : "Verwenden Sie keine gemischten Identifikationsdaten.",
    ...
    "Empty root certificate data" : "Leere Stammzertifikatsdaten",
    ...
    "Search signer by account" : "Unterzeichner über Konto suchen",
    "Name" : "Name",
    "No recommendations. Start typing." : "Keine Empfehlungen. Beginnen Sie mit der Eingabe.",
    "Account is mandatory" : "Konto ist erforderlich",
    "Searching …" : "Suche …",
    "No elements found." : "Keine Elemente gefunden.",
    "E-mail of signer" : "E-Mail des Unterzeichners",
    ...
    "Upload certificate" : "Zertifikat aktualisieren",
    ...
    "Certificate engine to generate the root certificate" : "Zertifikats-Engine zum Erstellen des Stammzertifikats",
    "Select the certificate engine to generate the root certificate" : "Zertifikats-Engine zum Erstellen des Stammzertifikats auswählen",
    "I will not use root certificate" : "Ich möchte kein Wurzelzertifikat verwenden",
    ...
    "Allow account creation for new users" : "Kontoerstellung für neue Benutzer zulassen",
    "Allows sending registration email when the user does not have an account." : "Versendung einer Registrierungs-E-Mail zulassen, wenn der Benutzer noch kein Konto hat.",
    "Default signature method" : "Standard-Signaturmethode",
    ...
    "Regenerate root certificate will invalidate all signatures keys. Do you confirm this action?" : "Das neu erstellen des Stammzertifikats macht alle Signaturschlüssel ungültig. Bestätigen Sie diese Aktion?",
    ...
    "Root certificate data" : "Wurzelzertifikatsdaten",
