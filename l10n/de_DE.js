OC.L10N.register(
    ...
    "Date and time when the signer send the request to sign (in their local time zone)." : "Datum und Uhrzeit, zu der der Unterzeichner die Signaturanforderung gesendet hat (in seiner lokalen Zeitzone).",
